...
void main() {
  ...
  `},qc={system:`lorenz_84`,paramCount:5,isDiscreteMap:!1,disturbIndices:[0,2],glslStep:`
  ...
  `},Jc={system:`pickover`,paramCount:4,isDiscreteMap:!0,disturbIndices:[0,2],glslStep:`
    vec3 stepAttractor(vec3 p, float params[4]) {
      float A = params[0];
      float B = params[1];
      float C = params[2];
  ...
  `},Yc={system:`polynomial_a`,paramCount:3,isDiscreteMap:!0,disturbIndices:[0,1,2],glslStep:`
  ...
  `},Xc={system:`polynomial_b`,paramCount:6,isDiscreteMap:!0,disturbIndices:[0,1,2,3,4,5],glslStep:`
  ...
  `},Zc={system:`chaotic_flow`,paramCount:22,isDiscreteMap:!1,disturbIndices:[0,7,14],glslStep:`
  ...
  `},Qc={system:`polynomial_c`,paramCount:18,isDiscreteMap:!0,disturbIndices:[1,7,13],glslStep:`
  ...
  `};function $c(e){let t=Array(40).fill(0),n;n=e.length<=21?0:e.length<=24?1:2;for(let n=0;n<e.length&&n<39;n++)t[n]=e[n];return t[39]=n,t}var el={system:`polynomial_func`,paramCount:40,isDiscreteMap:!0,disturbIndices:[0,1,2,3],glslStep:`
  ...
  `},tl={system:`polynomial_sprott`,paramCount:168,isDiscreteMap:!0,disturbIndices:[0,56,112],glslStep:`
  ...
  `};function nl(e,t){let n=Array(9);for(let r=0;r<3;r++)for(let i=0;i<3;i++)n[r*3+i]=e[r*3]*t[i]+e[r*3+1]*t[3+i]+e[r*3+2]*t[6+i];return n}function rl(e){let t=[],n=[];for(let r=0;r+16<=e.length;r+=16){let[i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y]=e.slice(r,r+16),b=Math.cos,x=Math.sin,S=[b(o),-x(o),0,x(o),b(o),0,0,0,1],C=[b(a),0,x(a),0,1,0,-x(a),0,b(a)],w=[1,0,0,0,b(i),-x(i),0,x(i),b(i)],T=nl(nl(S,C),w),E=[1,u,d,f,1,p,m,h,1],D=[s,0,0,0,c,0,0,0,l],O=nl(nl(T,E),D);t.push(...O,g,_,v,0),n.push(y)}let r=n.reduce((e,t)=>e+Math.max(0,t),0)||1;return n.forEach((e,n)=>{t[n*13+12]=Math.max(0,e)/r}),t}function il(e,t,n){let r=Math.floor(e.length/13),i=n(),a=(r-1)*13;for(let t=0;t<r;t++)if(i-=e[t*13+12],i<=0){a=t*13;break}let o=e[a]*t.x+e[a+1]*t.y+e[a+2]*t.z+e[a+9],s=e[a+3]*t.x+e[a+4]*t.y+e[a+5]*t.z+e[a+10],c=e[a+6]*t.x+e[a+7]*t.y+e[a+8]*t.z+e[a+11];t.x=o,t.y=s,t.z=c}var al={system:`ifs`,paramCount:`variable`,isDiscreteMap:!0,disturbStride:{stride:13,offsets:[9,10,11]},glslStep:`
  ...
  `},ol={system:`icon`,paramCount:6,isDiscreteMap:!0,disturbIndices:[3,1],glslStep:`
    vec3 stepAttractor(vec3 p, float params[6]) {
  ...
  `},sl={system:`unravel`,paramCount:7,isDiscreteMap:!0,disturbIndices:[0,1],glslStep:`
  ...
  `};function cl(e,t,n){let r=Math.max(2,Math.round(e[0])),i=e[3],a=e[1],o=e[2]*Math.cos(i),s=e[2]*Math.sin(i),c=t.x-a,l=t.y-o,u=t.z-s,d=t.w,f=Math.hypot(c,l,u,d),p=Math.hypot(l,u,d),m=Math.atan2(p,c),h=p>1e-12?l/p:1,g=p>1e-12?u/p:0,_=p>1e-12?d/p:0,v=Math.floor(n()*r),y=(m+2*Math.PI*v)/r,b=f**(1/r);t.x=b*Math.cos(y);let x=b*Math.sin(y);t.y=x*h,t.z=x*g,t.w=x*_}var ll={lorenz:Kc,lorenz_84:qc,pickover:Jc,polynomial_a:Yc,polynomial_b:Xc,chaotic_flow:Zc,polynomial_c:Qc,polynomial_func:el,polynomial_sprott:tl,ifs:al,icon:ol,unravel:sl,julia:{system:`julia`,paramCount:4,isDiscreteMap:!0,stateW:!0,disturbIndices:[1,2],glslStep:`
...
void main() {
...
}`,_l=e=>`params[${e}] += uPerturbation * (0.15 * sin(dot(uv, vec2(12.9898, 78.233)) * 43758.5453 + float(${e})));`;function vl(e,t){let n;if(e.disturbStride){let{stride:r,offsets:i}=e.disturbStride;n=[];for(let e=0;e*r<t;e++)for(let t of i)n.push(_l(e*r+t))}else n=(e.disturbIndices??[]).map(_l);let r=e.glslStep.replaceAll(`__N__`,String(t)),i=e.stateW===!0,a=e.randomReseed;return`
  ...
  `}function yl(e,t){if(t&&t.points.length>=3){let n=Math.floor(t.points.length/3),r=t.jitter;for(let i=0;i<e.length;i+=4){let a=Math.floor(Math.random()*n)*3;e[i]=t.points[a]+(Math.random()-.5)*r,e[i+1]=t.points[a+1]+(Math.random()-.5)*r,e[i+2]=t.points[a+2]+(Math.random()-.5)*r,e[i+3]=1}return}for(let t=0;t<e.length;t+=4)e[t]=(Math.random()-.5)*.1,e[t+1]=(Math.random()-.5)*.1,e[t+2]=(Math.random()-.5)*.1,e[t+3]=1}var bl=class{points;gpuCompute;positionVariable;material;tier;constructor(e,t,n,r,i,a){this.tier=r,this.gpuCompute=new ml(r,r,e);let o=this.gpuCompute.createTexture(),s=o.image.data;yl(s,i);let c=t.paramCount===`variable`?n.length:t.paramCount;this.positionVariable=this.gpuCompute.addVariable(`texturePosition`,vl(t,c),o),this.gpuCompute.setVariableDependencies(this.positionVariable,[this.positionVariable]),this.positionVariable.material.uniforms.uParamsA={value:n.slice()},this.positionVariable.material.uniforms.uParamsB={value:n.slice()},this.positionVariable.material.uniforms.uMorphMix={value:0},this.positionVariable.material.uniforms.uPerturbation={value:0},this.positionVariable.material.uniforms.uFrame={value:0};let l=this.gpuCompute.init();if(l!==null)throw Error(`GPUComputationRenderer init failed: ${l}`);for(let e=0;e<150;e++)this.positionVariable.material.uniforms.uFrame.value=e,this.gpuCompute.compute();let u=r*r,d=r>=2048?1.2:r>=1024?1.6:3.5,f=Math.min(1,Math.max(.12,1024*1024*1.6*1.6*.5*1.7/(u*d*d))),p=new rr;p.setAttribute(`position`,new Hn(new Float32Array(u*3),3)),this.material=new oi({vertexShader:hl,fragmentShader:gl,transparent:!0,blending:2,depthWrite:!1,uniforms:{uPosition:{value:this.gpuCompute.getCurrentRenderTarget(this.positionVariable).texture},uTexSize:{value:r},uPointSize:{value:d},uAlpha:{value:f},uBrightness:{value:1},uCalibration:{value:1},uTint:{value:a?a.clone():new Z(1,1,1)}}}),this.points=new Wr(p,this.material),this.points.frustumCulled=!1}setParams(e){this.positionVariable.material.uniforms.uParamsA.value=e.slice()}setMorphTarget(e,t){e&&(this.positionVariable.material.uniforms.uParamsB.value=e.slice()),this.positionVariable.material.uniforms.uMorphMix.value=t}setPerturbation(e){this.positionVariable.material.uniforms.uPerturbation.value=e}calibrate(e,t){let n=this.material.uniforms.uTint.value;if(n.r>.99&&n.g>.99&&n.b>.99)return;let r=t.aspect||1,i=Math.max(1,Math.round(Math.sqrt(512*512/r))),a=Math.max(1,Math.round(i*r)),o=null;try{o=new Ct(a,i);let n=new ln;n.add(this.points);let r=e.getRenderTarget(),s=new Uint8Array(a*i*4);for(let r=0;r<3;r++){e.setRenderTarget(o),e.clear(),e.render(n,t),e.readRenderTargetPixels(o,0,0,a,i,s);let r=0,c=0;for(let e=0;e<a*i;e++){let t=s[e*4],n=s[e*4+1],i=s[e*4+2];t<4&&n<4&&i<4||(r++,t>250&&n>250&&i>250&&c++)}if(r<8)break;let l=c/r;if(l<.35)break;this.material.uniforms.uCalibration.value=Math.max(.02,this.material.uniforms.uCalibration.value*(1-l))}e.setRenderTarget(r)}catch{}finally{o?.dispose()}}setBrightness(e){this.material.uniforms.uBrightness.value=Math.max(.1,e)}compute(){let e=this.positionVariable.material.uniforms.uFrame;e.value=(e.value+1)%1048576,this.gpuCompute.compute(),this.material.uniforms.uPosition.value=this.gpuCompute.getCurrentRenderTarget(this.positionVariable).texture}dispose(){this.points.geometry.dispose(),this.material.dispose(),this.gpuCompute.dispose()}},xl=.12;function Sl(e){if(e.length===0)return new Z(1,1,1);let t=e.map(e=>{let t=new Z(e),n={h:0,s:0,l:0};return t.getHSL(n),n}),n=t.filter(e=>e.l>.08&&e.l<.95),r=n.length>0?n:t,i=r.reduce((e,t)=>t.s>e.s?t:e,r[0]);if(i.s<xl)return new Z(1,1,1);let a=Math.min(.7,Math.max(.45,i.l));return new Z().setHSL(i.h,Math.max(i.s,.35),a)}function Cl(e){return e.webgl2?e.isMobile?256:(e.deviceMemoryGB??0)>=8?2048:1024:null}function wl(e){return{azimuth:0,elevation:0,radius:10,target:e}}function Tl(e,t,n){let r=e.azimuth-t*.005,i=Math.max(-1.4,Math.min(1.4,e.elevation-n*.005));return{...e,azimuth:r,elevation:i}}function El(e,t){let n=Math.max(3,Math.min(30,e.radius*Math.exp(t*.0015)));return{...e,radius:n}}function Dl(e){let{azimuth:t,elevation:n,radius:r,target:i}=e;return{x:i.x+r*Math.cos(n)*Math.sin(t),y:i.y+r*Math.sin(n),z:i.z+r*Math.cos(n)*Math.cos(t)}}var Ol=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],kl=new Set([34,5]);function Al(e,t){return(e-1+t+365)%365+1}function jl(e){let{month:t,date:n}=Dc(e.day);return`${String(e.day).padStart(3,`0`)}/365 · ${e.title} · ${Ol[t-1]} ${n}, 2010`}var Ml={lorenz:`Lorenz`,lorenz_84:`Lorenz-84`,icon:`Field–Golubitsky icon`,pickover:`Pickover`,chaotic_flow:`Chaotic flow`,polynomial_a:`Polynomial A`,polynomial_b:`Polynomial B`,polynomial_c:`Polynomial C`,polynomial_func:`Polynomial`,polynomial_sprott:`Polynomial (Sprott)`,julia:`Julia (quaternion)`,ifs:`IFS`,unravel:`Unravel`,incendia_ifs:`Incendia IFS`,incendia_flow:`Incendia flow`};function Nl(e){return e?Ml[e]??null:null}function Pl(e,t){return!e||!t||e.system===`static-only`||t.system===`static-only`||e.system!==t.system||e.params&&t.params&&(e.params.length!==t.params.length||e.system===`icon`&&e.params[0]!==t.params[0]||e.system===`julia`&&e.params[0]!==t.params[0])?`dissolve`:`morph`}function Fl(e,t){return e===`ifs`?rl(t):e===`polynomial_func`?$c(t):t}function Il(e,t,n,r){for(let t=0;t<n;t++)e();let i=1/0,a=-1/0,o=1/0,s=-1/0,c=1/0,l=-1/0,u=Math.max(1,Math.floor(r/4096)),d=[];for(let n=0;n<r&&(e(),!(!isFinite(t.x)||!isFinite(t.y)||!isFinite(t.z)));n++)i=Math.min(i,t.x),a=Math.max(a,t.x),o=Math.min(o,t.y),s=Math.max(s,t.y),c=Math.min(c,t.z),l=Math.max(l,t.z),n%u===0&&d.push(t.x,t.y,t.z);let f=Math.max(isFinite(a)&&isFinite(i)?(a-i)/2:0,isFinite(s)&&isFinite(o)?(s-o)/2:0,isFinite(l)&&isFinite(c)?(l-c)/2:0),p=f>.001?4/f:1,m=isFinite(i)&&isFinite(a)?(i+a)/2:0,h=isFinite(o)&&isFinite(s)?(o+s)/2:0,g=isFinite(c)&&isFinite(l)?(c+l)/2:0,_=f>.001?f*2*.01:.05;return{scale:p,centerX:m,centerY:h,centerZ:g,seed:{points:Float32Array.from(d),jitter:_}}}function Ll(e){let[t,n,r,i,a]=e,o={x:.1,y:.1,z:.1};return Il(()=>{let e=-o.y*o.y-o.z*o.z-t*o.x+t*r,s=o.x*o.y-n*o.x*o.z-o.y+i,c=n*o.x*o.y+o.x*o.z-o.z;o.x+=e*a,o.y+=s*a,o.z+=c*a},o,2e3,2e3)}function Rl(e){let t=e,n=t[21],r=(e,t,n,r)=>{let i=Math.round(e);return i<=0?1:i===1?t:i===2?n:r},i={x:.1,y:.1,z:.1};return Il(()=>{let{x:e,y:a,z:o}=i,s=t[0]*r(t[1],e,a,o)*e+t[2]*r(t[3],e,a,o)*a+t[4]*r(t[5],e,a,o)*o+t[6],c=t[7]*r(t[8],e,a,o)*e+t[9]*r(t[10],e,a,o)*a+t[11]*r(t[12],e,a,o)*o+t[13],l=t[14]*r(t[15],e,a,o)*e+t[16]*r(t[17],e,a,o)*a+t[18]*r(t[19],e,a,o)*o+t[20];i.x+=s*n,i.y+=c*n,i.z+=l*n},i,2e3,4e3)}function zl(e){let t=e,n={x:.1,y:.1,z:.1};return Il(()=>{let{x:e,y:r,z:i}=n,a=t[0]+e*(t[1]+t[2]*e+t[3]*r)+r*(t[4]+t[5]*r),o=t[6]+r*(t[7]+t[8]*r+t[9]*i)+i*(t[10]+t[11]*i),s=t[12]+i*(t[13]+t[14]*i+t[15]*e)+e*(t[16]+t[17]*e);n.x=a,n.y=o,n.z=s},n,3e3,3e3)}function Bl(e){let[t,n,r]=e,i={x:0,y:0,z:0};return Il(()=>{let{x:e,y:a,z:o}=i,s=t+a-o*a,c=n+o-e*o,l=r+e-a*e;i.x=s,i.y=c,i.z=l},i,3e3,3e3)}function Vl(e){let[t,n,r,i,a,o]=e,s={x:0,y:0,z:0};return Il(()=>{let{x:e,y:c,z:l}=s,u=t+c-l*(n+c),d=r+l-e*(i+l),f=a+e-c*(o+e);s.x=u,s.y=d,s.z=f},s,3e3,3e3)}function Hl(e){let t=$c(e),n=t[39],r={x:.1,y:.1,z:.1};return Il(()=>{let{x:e,y:i,z:a}=r,o=Math.abs(e),s=Math.abs(i),c=Math.abs(a),l,u,d;n<.5?(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*o+t[5]*s+t[6]*c,u=t[7]+t[8]*e+t[9]*i+t[10]*a+t[11]*o+t[12]*s+t[13]*c,d=t[14]+t[15]*e+t[16]*i+t[17]*a+t[18]*o+t[19]*s+t[20]*c):n<1.5?(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*o+t[5]*s+t[6]*c**+t[7],u=t[8]+t[9]*e+t[10]*i+t[11]*a+t[12]*o+t[13]*s+t[14]*c**+t[15],d=t[16]+t[17]*e+t[18]*i+t[19]*a+t[20]*o+t[21]*s+t[22]*c**+t[23]):(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*Math.sin(t[5]*t[6]*e)+t[7]*Math.sin(t[8]*t[9]*i)+t[10]*Math.sin(t[11]*t[12]*a),u=t[13]+t[14]*e+t[15]*i+t[16]*a+t[17]*Math.sin(t[18]*t[19]*e)+t[20]*Math.sin(t[21]*t[22]*i)+t[23]*Math.sin(t[24]*t[25]*a),d=t[26]+t[27]*e+t[28]*i+t[29]*a+t[30]*Math.sin(t[31]*t[32]*e)+t[33]*Math.sin(t[34]*t[35]*i)+t[36]*Math.sin(t[37]*t[38]*a)),r.x=l,r.y=u,r.z=d},r,3e3,3e3)}function Ul(e){let t=rl(e),n={x:.1,y:.1,z:.1};return Il(()=>il(t,n,Math.random),n,200,4e3)}function Wl(e){let t={x:.1,y:.1,z:.1};return Il(()=>il(e,t,Math.random),t,200,4e3)}function Gl(e){let t=Math.round(e[0]),[,n,r,i,a,o]=e,s={x:.1,y:.1,z:0};return Il(()=>{let e=1,c=0;for(let n=0;n<t-1;n++){let t=e*s.x-c*s.y;c=e*s.y+c*s.x,e=t}let l=i+n*(s.x*s.x+s.y*s.y)+r*(s.x*e-s.y*c),u=l*s.x+a*e-o*s.y,d=l*s.y-a*c+o*s.x;s.x=u,s.y=d,s.z=Math.abs(l)},s,500,4e3)}function Kl(e){let[t,n,r,i,a,o,s]=e,c={x:.1,y:.1,z:.1};return Il(()=>{let e=i*(c.z+t),l=a*(c.x+n),u=o*(c.y+r),d=Math.hypot(e,l,u);if(d>s&&s>0){let t=1-s*(Math.floor(d/s)+1)/d;e*=t,l*=t,u*=t}c.x=e,c.y=l,c.z=u},c,500,4e3)}function ql(e){let t={x:.5,y:.3,z:.2,w:.1},n={x:t.x,y:t.y,z:t.z};return Il(()=>{cl(e,t,Math.random),n.x=t.x,n.y=t.y,n.z=t.z},n,200,4e3)}var Jl=4,Yl=3,Xl=[1,2,4,8,16,32,64];function Zl(e){let t=Yl*Math.hypot(e[9],e[10],e[11])||.1,n=[],r=Xl[Xl.length-1];for(let t=0;t<200;t++){let t={x:(Math.random()-.5)*4,y:(Math.random()-.5)*4,z:(Math.random()-.5)*4},i=0;for(let a=1;a<=r;a++)il(e,t,Math.random),a===Xl[i]&&(i++,Number.isFinite(t.x)&&Number.isFinite(t.y)&&Number.isFinite(t.z)&&n.push(t.x,t.y,t.z))}return{scale:Jl/t,centerX:0,centerY:0,centerZ:0,seed:{points:Float32Array.from(n),jitter:t*.02}}}var Ql=.2,$l=3.2,eu={lorenz:e=>({scale:Ql,centerX:0,centerY:0,centerZ:e.length>=2?e[1]-1:0}),pickover:()=>({scale:$l,centerX:0,centerY:0,centerZ:0}),lorenz_84:e=>({...Ll(e),seed:void 0}),chaotic_flow:Rl,polynomial_c:zl,polynomial_func:Hl,polynomial_a:Bl,polynomial_b:Vl,ifs:Ul,incendia_ifs:Wl,incendia_flow:Zl,icon:Gl,unravel:Kl,julia:ql},tu=`la-brightness`;function nu(){let e=Number(localStorage.getItem(tu));return Number.isFinite(e)&&e>0?e:1}var ru=class{overlay;onNavigate;onClose;root;img;sources;caption;prevBtn;nextBtn;listenBtn;audioEl=new Audio;current=null;bySlug;byDay;live_;attractorsByDay=new Map;tier=null;liveAttractor=null;orbit=null;orbitDragging=!1;orbitLast={x:0,y:0};orbitMoved=0;disturbHeld=!1;disturbAmount=0;brightness=nu();constructor(e,t,n,r,i){this.overlay=e,this.onNavigate=n,this.onClose=r,this.bySlug=new Map(t.map(e=>[e.slug,e])),this.byDay=new Map(t.map(e=>[e.day,e])),this.root=document.createElement(`div`),this.root.className=`piece hidden`,this.root.innerHTML=`
      ...
      <button class="piece-close" aria-label="Return to the constellation" title="Return to the constellation"><span class="glyph">×</span> Sky</button>`,e.appendChild(this.root);let a=this.root.querySelector(`.piece-backdrop`),[o,s]=this.root.querySelectorAll(`source`);this.sources={avif:o,webp:s},this.img=this.root.querySelector(`img`),this.caption=this.root.querySelector(`figcaption`),this.prevBtn=this.root.querySelector(`.prev`),this.nextBtn=this.root.querySelector(`.next`),this.listenBtn=document.createElement(`button`),this.listenBtn.className=`piece-listen`,this.listenBtn.addEventListener(`click`,()=>{this.audioEl.paused?(this.audioEl.play().catch(()=>{this.listenBtn.textContent=`▶ Listen`}),this.listenBtn.textContent=`❚❚ Pause`):(this.audioEl.pause(),this.listenBtn.textContent=`▶ Listen`)}),this.audioEl.addEventListener(`ended`,()=>{this.listenBtn.textContent=`▶ Listen`}),this.root.querySelector(`.prev`).addEventListener(`click`,()=>this.nav(-1)),this.root.querySelector(`.next`).addEventListener(`click`,()=>this.nav(1)),this.root.querySelector(`.piece-close`).addEventListener(`click`,()=>this.requestClose()),this.root.addEventListener(`click`,e=>{(e.target===this.root||e.target===a)&&this.requestClose()}),addEventListener(`keydown`,e=>{this.isOpen()&&(e.key===`Escape`&&this.requestClose(),e.key===`ArrowLeft`&&this.nav(-1),e.key===`ArrowRight`&&this.nav(1))}),this.live_=i,i.brightnessSlider.value=String(this.brightness),i.brightnessSlider.addEventListener(`input`,()=>{this.brightness=Number(i.brightnessSlider.value),localStorage.setItem(tu,String(this.brightness)),this.liveAttractor?.setBrightness(this.brightness)}),this.attractorsByDay=new Map(i.attractors.map(e=>[e.day,e])),this.tier=Cl({webgl2:i.renderer.capabilities.isWebGL2,isMobile:/Mobi|Android/i.test(navigator.userAgent),deviceMemoryGB:navigator.deviceMemory}),this.bindOrbitEvents()}bindOrbitEvents(){let e=this.live_.canvas;e.addEventListener(`pointerdown`,e=>{this.liveAttractor&&(e.target.closest(`button`)||(this.orbitDragging=!0,this.orbitLast={x:e.clientX,y:e.clientY},this.orbitMoved=0,this.disturbHeld=!0))}),addEventListener(`pointermove`,e=>{if(!this.liveAttractor||!this.orbitDragging||!this.orbit)return;let t=e.clientX-this.orbitLast.x,n=e.clientY-this.orbitLast.y;this.orbit=Tl(this.orbit,t,n),this.orbitLast={x:e.clientX,y:e.clientY},this.orbitMoved+=Math.hypot(t,n),this.orbitMoved>5&&(this.disturbHeld=!1)}),addEventListener(`pointerup`,()=>{this.orbitDragging=!1,this.disturbHeld=!1}),e.addEventListener(`wheel`,e=>{!this.liveAttractor||!this.orbit||(e.preventDefault(),this.orbit=El(this.orbit,e.deltaY))},{passive:!1})}nav(e){if(!this.current)return;let t=this.byDay.get(Al(this.current.day,e)),n=this.attractorsByDay.get(this.current.day),r=this.attractorsByDay.get(t.day);if(Pl(n?{day:n.day,system:n.system,params:n.params}:null,r?{day:r.day,system:r.system,params:r.params}:null)===`morph`&&this.liveAttractor&&r?.params){let e=this.liveAttractor,t=Fl(r.system,r.params);e.setMorphTarget(t,0);let n=performance.now(),i=()=>{if(this.liveAttractor!==e)return;let r=Math.min(1,(performance.now()-n)/800);e.setMorphTarget(t,r),r<1?requestAnimationFrame(i):(e.setParams(t),e.setMorphTarget(null,0))};requestAnimationFrame(i)}this.orbit=null,this.audioEl.pause(),this.onNavigate(t.slug)}requestClose(){this.close(),this.onClose()}open(e){let t=this.bySlug.get(e);if(!t)return;this.current=t;let n=e=>`${Tc(t.slug,1024,e)} 1024w, ${Tc(t.slug,2e3,e)} 2000w`;this.sources.avif.srcset=n(`avif`),this.sources.webp.srcset=n(`webp`),this.img.srcset=n(`jpg`),this.img.src=Tc(t.slug,1024,`jpg`),this.img.alt=`${t.title} — strange attractor, day ${t.day} of 365, 2010`,this.caption.textContent=jl(t);let r=this.byDay.get(Al(t.day,-1)),i=this.byDay.get(Al(t.day,1));this.prevBtn.dataset.label=`day ${String(r.day).padStart(3,`0`)}`,this.prevBtn.title=`day ${String(r.day).padStart(3,`0`)} · ${r.title}`,this.prevBtn.setAttribute(`aria-label`,`Previous — day ${r.day}: ${r.title}`),this.nextBtn.dataset.label=`day ${String(i.day).padStart(3,`0`)}`,this.nextBtn.title=`day ${String(i.day).padStart(3,`0`)} · ${i.title}`,this.nextBtn.setAttribute(`aria-label`,`Next — day ${i.day}: ${i.title}`);let a=Nl(this.attractorsByDay.get(t.day)?.system);if(a){let e=document.createElement(`span`);e.className=`caption-meta`,e.textContent=a,this.caption.append(document.createElement(`br`),e)}this.audioEl.pause(),t.audio?(this.audioEl.src=t.audio,this.listenBtn.textContent=`▶ Listen`,this.caption.append(document.createElement(`br`),this.listenBtn)):this.audioEl.removeAttribute(`src`),this.root.classList.remove(`hidden`);for(let e of[1,-1]){let n=this.byDay.get(Al(t.day,e));new Image().src=Tc(n.slug,1024,`jpg`)}this.liveAttractor?.dispose(),this.liveAttractor=null;let o=this.attractorsByDay.get(t.day),s=o&&o.system!==`static-only`?ul(o.system):null;if(s&&o?.params&&this.tier&&!kl.has(t.day))try{let e=eu[o.system]?.(o.params)??{scale:1,centerX:0,centerY:0,centerZ:0},n=e.seed&&e.seed.points.length>=3?e.seed:void 0,r=Fl(o.system,o.params),i=Sl(t.palette);if(this.liveAttractor=new bl(this.live_.renderer,s,r,this.tier,n,i),!s.isDiscreteMap){let e=o.params[o.params.length-1];if(e>0){let t=Math.min(2e4,Math.ceil(20/e));for(let e=0;e<t;e++)this.liveAttractor.compute()}}this.liveAttractor.points.scale.setScalar(e.scale),this.liveAttractor.points.position.set(t.x-e.scale*e.centerX,t.y-e.scale*e.centerY,8-e.scale*e.centerZ),this.orbit=wl({x:t.x,y:t.y,z:8});let a=Dl(this.orbit);this.live_.camera.position.set(a.x,a.y,a.z),this.live_.camera.lookAt(this.orbit.target.x,this.orbit.target.y,this.orbit.target.z),this.liveAttractor.calibrate(this.live_.renderer,this.live_.camera),this.liveAttractor.setBrightness(this.brightness),this.live_.liveScene.add(this.liveAttractor.points),this.live_.controls.setEnabled(!1)}catch(e){console.error(`live attractor init failed, falling back to static`,e),this.liveAttractor=null,this.orbit=null}this.live_.modeToggle.style.display=this.liveAttractor?`flex`:`none`,this.live_.brightnessSlider.style.display=this.liveAttractor?`block`:`none`,this.root.classList.toggle(`live-active`,!!this.liveAttractor)}close(){this.audioEl.pause(),this.liveAttractor?.dispose(),this.liveAttractor=null,this.orbit=null,this.disturbHeld=!1,this.disturbAmount=0,this.live_.controls.setEnabled(!0),this.live_.modeToggle.style.display=`none`,this.live_.brightnessSlider.style.display=`none`,this.root.classList.remove(`live-active`),this.root.classList.add(`hidden`),this.current=null,this.live_.camera.quaternion.identity()}isOpen(){return this.current!==null}hasLiveSupport(){return this.tier!==null}toggleHideStatic(){return this.root.classList.toggle(`hide-static`)}isHidingStatic(){return this.root.classList.contains(`hide-static`)}currentSystem(){return this.current?this.attractorsByDay.get(this.current.day)?.system:void 0}isShowingLiveFullscreen(){return!!this.liveAttractor&&this.root.classList.contains(`hide-static`)}updateDisturb(e){if(!this.liveAttractor)return;let t=+!!this.disturbHeld,n=this.disturbHeld?1/.3:1/1.5;this.disturbAmount+=(t-this.disturbAmount)*Math.min(1,n*e),this.liveAttractor.setPerturbation(this.disturbAmount)}render(e){if(this.liveAttractor&&this.orbit){let e=Dl(this.orbit);this.live_.camera.position.set(e.x,e.y,e.z),this.live_.camera.lookAt(this.orbit.target.x,this.orbit.target.y,this.orbit.target.z)}this.updateDisturb(e),this.liveAttractor?.compute()}},iu=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`];function au(e,t){let n=t.trim().toLowerCase();if(!n)return[];let r=[];if(/^\d{1,3}$/.test(n)){let t=parseInt(n,10),i=e.find(e=>e.day===t);i&&r.push(i)}for(let t of e){if(r.length>=8)break;!r.includes(t)&&t.title.toLowerCase().includes(n)&&r.push(t)}return r.slice(0,8)}var ou=class{artworks;onPick;root;results;openState=!1;constructor(e,t,n){this.artworks=t,this.onPick=n,this.root=document.createElement(`div`),this.root.className=`indexview hidden`;let r=document.createElement(`input`);r.type=`search`,r.placeholder=`day number or title…`,r.setAttribute(`aria-label`,`Search artworks`),this.results=document.createElement(`div`),this.results.className=`index-results`,this.root.append(r,this.results),r.addEventListener(`input`,()=>this.renderResults(au(this.artworks,r.value))),new Map(t.map(e=>[e.day,e]));for(let e=0;e<12;e++){let n=document.createElement(`h2`);n.textContent=iu[e];let r=document.createElement(`div`);r.className=`month-grid`,this.root.append(n,r);for(let n of t)Dc(n.day).month===e+1&&r.appendChild(this.cell(n))}e.appendChild(this.root)}cell(e){let t=document.createElement(`a`);t.className=`day-cell`,t.href=`/day/${e.slug}/`,t.title=`${String(e.day).padStart(3,`0`)} · ${e.title}`;let n=document.createElement(`img`);n.loading=`lazy`,n.src=Tc(e.slug,256,`jpg`),n.alt=e.title;let r=document.createElement(`span`);return r.textContent=String(Dc(e.day).date),t.append(n,r),t.addEventListener(`click`,t=>{t.preventDefault(),this.onPick(e.slug)}),t}renderResults(e){this.results.innerHTML=``;for(let t of e){let e=document.createElement(`a`);e.href=`/day/${t.slug}/`,e.textContent=`${String(t.day).padStart(3,`0`)} · ${t.title}`,e.addEventListener(`click`,e=>{e.preventDefault(),this.onPick(t.slug)}),this.results.appendChild(e)}}open(){this.openState=!0,this.root.classList.remove(`hidden`)}close(){this.openState=!1,this.root.classList.add(`hidden`)}isOpen(){return this.openState}},su=140,cu=60,lu=class{artworks;cv;ctx;dotColors;constructor(e,t,n){this.artworks=t,this.cv=document.createElement(`canvas`),this.cv.id=`minimap`,this.cv.width=this.cv.height=su*2,e.appendChild(this.cv),this.ctx=this.cv.getContext(`2d`),this.dotColors=t.map(e=>`#`+Sl(e.palette).getHexString()),this.cv.addEventListener(`click`,e=>{let t=this.cv.getBoundingClientRect();n(((e.clientX-t.left)/su-.5)*2*cu,-((e.clientY-t.top)/su-.5)*2*cu)})}update(e,t,n){let r=this.ctx,i=su*2;r.clearRect(0,0,i,i),r.fillStyle=`rgba(10,12,18,0.85)`,r.fillRect(0,0,i,i),r.strokeStyle=`rgba(255,255,255,0.15)`,r.lineWidth=1,r.strokeRect(.5,.5,i-1,i-1);let a=e=>(e/cu/2+.5)*i,o=e=>(-e/cu/2+.5)*i;this.artworks.forEach((e,t)=>{let i=n(t);r.fillStyle=this.dotColors[t],r.fillRect(a(i.x)-1.5,o(i.y)-1.5,3,3)});let s=Rc(e,t.clientHeight),c=t.clientWidth*s,l=t.clientHeight*s;r.strokeStyle=`#cfd3dc`,r.lineWidth=2,r.strokeRect(a(e.position.x-c/2),o(e.position.y+l/2),c/cu/2*i,l/cu/2*i)}};async function uu(){return fetch(Sc(`/data/music.json`)).then(e=>e.json())}function du(e){let t=[{label:`Apple Music`,url:e.appleMusicUrl}];return e.youtubeUrl&&t.push({label:`YouTube`,url:e.youtubeUrl}),t}var fu=class{data;onClose;root;openState=!1;constructor(e,t,n){this.data=t,this.onClose=n,this.root=document.createElement(`div`),this.root.className=`musicview hidden`,this.root.innerHTML=`
      ...
      </div>`,e.appendChild(this.root),this.root.querySelector(`.story-close`).addEventListener(`click`,()=>this.requestClose()),this.root.addEventListener(`click`,e=>{e.target===this.root&&this.requestClose()}),addEventListener(`keydown`,e=>{this.isOpen()&&e.key===`Escape`&&this.requestClose()})}requestClose(){this.close(),this.onClose()}open(){this.openState=!0,this.root.classList.remove(`hidden`)}close(){this.openState=!1,this.root.classList.add(`hidden`)}isOpen(){return this.openState}},mu=[{kind:`today`,label:`Today`,title:`Today — this date's attractor (or press t)`},{kind:`attractors`,label:`Attractors`,title:`Attractors — browse all 365 days (or press /)`},{kind:`sound`,label:`Sound`,title:`Sound — music from the attractors`},{kind:`story`,label:`Story`,title:`Story — one attractor a day, 2010`}],hu=class{root;links=new Map;constructor(e,t,n){this.root=document.createElement(`nav`),this.root.id=`nav-row`;for(let e of mu){if(e.kind===`sound`&&!n.hasSound)continue;let r=document.createElement(`a`);r.href=`/${e.kind}/`,r.textContent=e.label,r.title=e.title,r.addEventListener(`click`,n=>{n.preventDefault(),t(e.kind)}),this.root.appendChild(r),this.links.set(e.kind,r)}e.appendChild(this.root)}setActive(e){for(let[t,n]of this.links)n.classList.toggle(`active`,t===e)}},gu=[31,28,31,30,31,30,31,31,30,31,30,31],_u=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`];function vu(e,t){let n=e===2&&t===29?28:t,r=0;for(let t=0;t<e-1;t++)r+=gu[t];return r+n}function yu(e,t){let n=vu(e.getMonth()+1,e.getDate());return t.find(e=>e.day===n)}function bu(e,t,n=1.6,r=.15){let i=n/r;return{x:e.x,y:e.y,z:i/(2*Math.tan(t*Math.PI/360))}}function xu(e){let{month:t,date:n}=Dc(e.day);return{label:`Day ${String(e.day).padStart(3,`0`)} · ${_u[t-1]} ${n}`,title:e.title}}async function Su(){let[{artworks:e,atlas:t},n,r]=await Promise.all([Cc(),wc(),uu().catch(()=>null)]),i=document.getElementById(`gl`),a=Ac(e),o;try{o=new Nc(i,e,t)}catch(e){console.error(`WebGL unavailable, falling back to static page`,e);return}document.querySelector(`.static-piece`)?.remove(),document.querySelector(`.static-nav`)?.remove();let s=matchMedia(`(prefers-reduced-motion: reduce)`);o.setReducedMotion(s.matches);let c=new Bc(i,o.camera,a,{reducedMotion:s.matches}),l=!1,u=!1,d=()=>{let t=i.clientWidth,n=i.clientHeight;if(!t||!n){requestAnimationFrame(f);return}o.resize();let r=Ic(Ac(e,l?`date`:`likeness`),t/n,o.camera.fov,.85);o.camera.position.set(r.x,r.y,r.z)},f=()=>{c.hasUserMoved()||u||d()};d(),addEventListener(`resize`,()=>{o.resize(),c.hasUserMoved()||d()}),s.addEventListener(`change`,()=>o.setReducedMotion(s.matches));let p=document.getElementById(`overlay`),m=document.createElement(`div`);m.id=`layout-switch`;let h=document.createElement(`button`);h.textContent=`Likeness`,h.title=`Arrange the constellation by visual similarity`;let g=document.createElement(`button`);g.textContent=`Date`,g.title=`Arrange the constellation by calendar date`,m.append(h,g),p.appendChild(m);let _=e=>{h.classList.toggle(`active`,!e),g.classList.toggle(`active`,e),h.setAttribute(`aria-pressed`,String(!e)),g.setAttribute(`aria-pressed`,String(e)),l=e,o.setTimeMix(+!!e),c.hasUserMoved()||d()};h.addEventListener(`click`,()=>_(!1)),g.addEventListener(`click`,()=>_(!0)),_(!1);let v=new lu(p,e,(e,t)=>c.flyTo(e,t,o.camera.position.z,.6)),y=yu(new Date,e),b=e.findIndex(e=>e.day===y.day);o.setHighlight(b);let x=document.createElement(`div`);x.id=`today-caption`;let S=xu(y),C=document.createElement(`small`);C.textContent=S.label;let w=document.createElement(`span`);if(w.textContent=S.title,x.append(C,w),!localStorage.getItem(`la-intro-seen`)){let e=document.createElement(`p`);e.className=`today-hints`,e.textContent=`drag to wander · scroll to dive · click to open`,x.appendChild(e)}p.appendChild(x);let T=()=>{x.classList.remove(`visible`),localStorage.setItem(`la-intro-seen`,`1`)};i.addEventListener(`pointerdown`,T,{once:!0}),i.addEventListener(`wheel`,T,{once:!0});let E=new Hc(p,e),D=null;i.addEventListener(`pointermove`,t=>{D=Vc(c.screenToWorld(t.clientX,t.clientY),e=>o.positionOf(e),e.length,1.2),o.setHover(D),i.style.cursor=D===null?`grab`:`pointer`});let O=document.createElement(`div`);O.id=`mode-toggle`;let k=document.createElement(`button`);k.textContent=`Image`,k.title=`Show the 2010 static render`;let A=document.createElement(`button`);A.textContent=`Orbit`,A.title=`Show only the live attractor`,O.append(k,A);let j=()=>{let e=F.isHidingStatic();k.classList.toggle(`active`,!e),A.classList.toggle(`active`,e),k.setAttribute(`aria-pressed`,String(!e)),A.setAttribute(`aria-pressed`,String(e)),A.textContent=F.currentSystem()===`incendia_flow`?`Flow`:`Orbit`};k.addEventListener(`click`,()=>{F.isHidingStatic()&&(F.toggleHideStatic(),j())}),A.addEventListener(`click`,()=>{F.isHidingStatic()||(F.toggleHideStatic(),j())});let M=document.createElement(`input`);M.id=`brightness-slider`,M.type=`range`,M.min=`0.4`,M.max=`6`,M.step=`0.1`,M.setAttribute(`aria-label`,`Live attractor brightness`);let N=new ln,P=new Map(e.map((e,t)=>[e.slug,t])),F=new ru(p,e,e=>L.go({kind:`day`,slug:e}),()=>L.go({kind:`home`}),{attractors:n,renderer:o.renderer,liveScene:N,camera:o.camera,canvas:i,controls:c,modeToggle:O,brightnessSlider:M});p.appendChild(O),p.appendChild(M),j();let I=null,ee=r?void 0:null,te=null,ne=new hu(p,e=>L.go({kind:e}),{hasSound:!!r});addEventListener(`keydown`,e=>{if(e.target instanceof HTMLInputElement)return;let t=F.isOpen()||I?.isOpen()||ee?.isOpen()||te?.isOpen();e.key===`/`&&!t&&(e.preventDefault(),L.go({kind:`attractors`})),e.key===`t`&&!t&&L.go({kind:`today`}),e.key===`Escape`&&I?.isOpen()&&L.go({kind:`home`})});let L=new Gc(async t=>{if(p.classList.toggle(`view-open`,t.kind!==`home`),ne.setActive(t.kind===`attractors`||t.kind===`sound`||t.kind===`story`?t.kind:null),t.kind===`today`){L.go({kind:`day`,slug:yu(new Date,e).slug},{replace:!0});return}if(t.kind===`sound`){if(F.close(),I?.close(),te?.close(),ee===void 0)try{ee=new fu(p,r,()=>L.go({kind:`home`}))}catch(e){console.error(`MusicView failed to construct, disabling Sound section`,e),ee=null}ee?.open();return}if(ee?.close(),t.kind===`attractors`){F.close(),te?.close(),(I??=new ou(p,e,e=>{I.close(),L.go({kind:`day`,slug:e})})).open();return}if(I?.close(),t.kind===`story`){F.close(),(te??=new pu(p,()=>L.go({kind:`home`}))).open();return}if(te?.close(),t.kind===`day`&&P.has(t.slug)){let e=P.get(t.slug),n=o.positionOf(e);await c.flyTo(n.x,n.y,8,.9),u=!0,F.open(t.slug),j()}else F.close()});c.onTap=(t,n)=>{if(F.isOpen())return;let r=Vc(c.screenToWorld(t,n),e=>o.positionOf(e),e.length,1.2);r!==null&&L.go({kind:`day`,slug:e[r].slug})},L.go(L.current(),{replace:!0}),L.current().kind===`home`&&(async()=>{if(await o.atlasReady,c.hasUserMoved()||L.current().kind!==`home`)return;let e=bu(o.positionOf(b),o.camera.fov),t=await c.flyTo(e.x,e.y,e.z,2.5,{cancellable:!0});u=!0,!(!t||c.hasUserMoved()||L.current().kind!==`home`)&&x.classList.add(`visible`)})();let re=0,ie=e=>{let t=Math.min(.05,(e-re)/1e3);re=e,c.update(t),o.render(e/1e3,F.isShowingLiveFullscreen()),F.isOpen()&&(F.render(t),o.renderer.autoClear=!1,o.renderer.render(N,o.camera),o.renderer.autoClear=!0),!F.isOpen()&&!I?.isOpen()&&!ee?.isOpen()&&!te?.isOpen()?(E.update(o.camera,i,e=>o.positionOf(e)),v.update(o.camera,i,e=>o.positionOf(e))):E.hide(),requestAnimationFrame(ie)};requestAnimationFrame(ie)}Su();