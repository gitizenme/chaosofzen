...
void main() {
...
}`,Nc=class{canvas;artworks;camera;renderer;scene=new ln;material;scaleAttr;scales;targetScales;posA;posB;mix=0;targetMix=0;glow;glowAttr;atlasReady;constructor(e,t,n){this.canvas=e,this.artworks=t,this.renderer=new xc({canvas:e,antialias:!0}),this.renderer.setPixelRatio(Math.min(devicePixelRatio,2)),this.camera=new Ri(50,1,.1,500),this.camera.position.set(0,0,120);let r=t.length;this.posA=new Float32Array(r*2),this.posB=new Float32Array(r*2);let i=new Float32Array(r*4);this.scales=new Float32Array(r).fill(1),this.targetScales=new Float32Array(r).fill(1),this.glow=new Float32Array(r),t.forEach((e,t)=>{this.posA[t*2]=e.x,this.posA[t*2+1]=e.y;let r=Oc(e.day);this.posB[t*2]=r.x,this.posB[t*2+1]=r.y;let a=kc(n,e.slug);i.set([a.u,a.v,a.su,a.sv],t*4)});let a=new Zr(1,1),o=new Bi;o.index=a.index,o.setAttribute(`position`,a.getAttribute(`position`)),o.setAttribute(`uv`,a.getAttribute(`uv`)),o.setAttribute(`aPosA`,new Ar(this.posA,2)),o.setAttribute(`aPosB`,new Ar(this.posB,2)),o.setAttribute(`aUv`,new Ar(i,4)),this.scaleAttr=new Ar(this.scales,1),o.setAttribute(`aScale`,this.scaleAttr),this.glowAttr=new Ar(this.glow,1),o.setAttribute(`aGlow`,this.glowAttr),o.instanceCount=r;let s;this.atlasReady=new Promise(e=>{s=e});let c=new Ai().load(n.files.small,()=>s());c.colorSpace=Ne,this.material=new oi({vertexShader:jc,fragmentShader:Mc,uniforms:{uAtlas:{value:c},uTime:{value:0},uDrift:{value:1},uMix:{value:0},uSize:{value:1.6},uBrightness:{value:1.25}}}),new Ai().load(n.files.full,e=>{e.colorSpace=Ne;let t=this.material.uniforms.uAtlas.value;this.material.uniforms.uAtlas.value=e,t.dispose()},void 0,e=>console.warn(`full-resolution atlas failed to load, staying on the preview tier`,e));let l=new Er(o,this.material);l.frustumCulled=!1,this.scene.add(l),this.resize()}setHover(e){this.targetScales.fill(1),e!==null&&(this.targetScales[e]=1.35)}setHighlight(e){this.glow.fill(0),e!==null&&(this.glow[e]=1),this.glowAttr.needsUpdate=!0}setTimeMix(e){this.targetMix=e}positionOf(e){let t={x:this.posA[e*2],y:this.posA[e*2+1]},n={x:this.posB[e*2],y:this.posB[e*2+1]};return{x:t.x+(n.x-t.x)*this.mix,y:t.y+(n.y-t.y)*this.mix}}setReducedMotion(e){this.material.uniforms.uDrift.value=+!e}resize(){let e=this.canvas.clientWidth,t=this.canvas.clientHeight;this.renderer.setSize(e,t,!1),this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}render(e,t=!1){this.mix+=(this.targetMix-this.mix)*.08,this.material.uniforms.uMix.value=this.mix,this.material.uniforms.uTime.value=e;let n=!1;for(let e=0;e<this.scales.length;e++){let t=this.targetScales[e]-this.scales[e];Math.abs(t)>.001&&(this.scales[e]+=t*.2,n=!0)}if(n&&(this.scaleAttr.needsUpdate=!0),t){this.renderer.clear();return}this.renderer.render(this.scene,this.camera)}};function Pc(e,t,n=4){let r=Math.exp(-n*t),i={x:e.x*r,y:e.y*r};return Math.hypot(i.x,i.y)<.01?{x:0,y:0}:i}function Fc(e,t,n,r){return{x:Math.min(t.maxX,Math.max(t.minX,e.x)),y:Math.min(t.maxY,Math.max(t.minY,e.y)),z:Math.min(r,Math.max(n,e.z))}}function Ic(e,t,n,r=.85){let i=Math.max(e.maxX-e.minX,1e-6),a=Math.max(e.maxY-e.minY,1e-6),o=Math.tan(n*Math.PI/360),s=a/r/(2*o),c=i/r/(2*o*t);return{x:(e.minX+e.maxX)/2,y:(e.minY+e.maxY)/2,z:Math.max(s,c,4)}}function Lc(e,t,n){return{x:t.x+(e.x-t.x)*n,y:t.y+(e.y-t.y)*n,z:e.z*n}}function Rc(e,t){return e<=0||t<=0?1:e/t}function zc(e,t){return 2*e.position.z*Math.tan(e.fov*Math.PI/360)/t}var Bc=e=>1-(1-e)**3,Vc=class{canvas;camera;bounds;onTap;vel={x:0,y:0};dragging=!1;moved=0;last={x:0,y:0};pointers=new Map;pinchDist=0;multiTouch=!1;flying=!1;reduced;ac=new AbortController;enabled=!0;userMoved=!1;flightId=0;cancellableFlight=!1;constructor(e,t,n,r={}){this.canvas=e,this.camera=t,this.bounds=n,this.reduced=r.reducedMotion??!1;let i=this.ac.signal;e.addEventListener(`pointerdown`,t=>{this.enabled&&(this.cancelFlight(),e.setPointerCapture(t.pointerId),this.pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),this.pointers.size>=2?(this.multiTouch=!0,this.dragging=!1,this.vel={x:0,y:0},this.pinchDist=this.currentPinchDist()):(this.dragging=!0,this.moved=0,this.vel={x:0,y:0},this.last={x:t.clientX,y:t.clientY}))},{signal:i}),e.addEventListener(`pointermove`,t=>{if(!this.enabled||this.flying)return;let n=this.pointers.get(t.pointerId);if(!n)return;if(n.x=t.clientX,n.y=t.clientY,this.pointers.size>=2){let e=this.currentPinchDist(),t=Rc(this.pinchDist,e);if(t!==1){this.userMoved=!0;let e=this.pinchMidpoint(),n=this.screenToWorld(e.x,e.y),r=Lc(this.camera.position,n,t);Object.assign(this.camera.position,Fc(r,this.bounds,4,this.fitZ()*1.1))}this.pinchDist=e;return}if(!this.dragging)return;this.userMoved=!0;let r=zc(this.camera,e.clientHeight),i=t.clientX-this.last.x,a=t.clientY-this.last.y;this.moved+=Math.hypot(i,a),this.camera.position.x-=i*r,this.camera.position.y+=a*r,this.vel={x:-i*r*60,y:a*r*60},this.last={x:t.clientX,y:t.clientY},this.clamp()},{signal:i});let a=e=>{if(!this.enabled)return;let t=this.pointers.delete(e.pointerId);if(this.pointers.size===1){let e=this.pointers.values().next().value;this.last={x:e.x,y:e.y},this.dragging=!0,this.moved=5,this.vel={x:0,y:0};return}this.pointers.size===0&&(this.dragging=!1,t&&!this.multiTouch&&this.moved<5&&(this.vel={x:0,y:0},this.onTap?.(e.clientX,e.clientY)),this.multiTouch=!1)};e.addEventListener(`pointerup`,a,{signal:i}),e.addEventListener(`pointercancel`,a,{signal:i});for(let t of[`gesturestart`,`gesturechange`,`gestureend`])e.addEventListener(t,e=>{this.enabled&&e.preventDefault()},{signal:i,passive:!1});e.addEventListener(`wheel`,e=>{if(!this.enabled||(e.preventDefault(),this.cancelFlight(),this.flying))return;this.userMoved=!0;let t=Math.exp(e.deltaY*.0015),n=this.screenToWorld(e.clientX,e.clientY),r=Lc(this.camera.position,n,t);Object.assign(this.camera.position,Fc(r,this.bounds,4,this.fitZ()*1.1))},{signal:i,passive:!1})}setEnabled(e){this.enabled=e}hasUserMoved(){return this.userMoved}currentPinchDist(){let e=this.pointers.values(),t=e.next().value,n=e.next().value;return!t||!n?0:Math.hypot(t.x-n.x,t.y-n.y)}pinchMidpoint(){let e=this.pointers.values(),t=e.next().value,n=e.next().value;return{x:(t.x+n.x)/2,y:(t.y+n.y)/2}}fitZ(){let e=this.canvas.clientWidth/this.canvas.clientHeight;return Ic(this.bounds,e,this.camera.fov,.85).z}screenToWorld(e,t){let n=zc(this.camera,this.canvas.clientHeight);return{x:this.camera.position.x+(e-this.canvas.clientWidth/2)*n,y:this.camera.position.y-(t-this.canvas.clientHeight/2)*n}}clamp(){Object.assign(this.camera.position,Fc(this.camera.position,this.bounds,4,this.fitZ()*1.1))}update(e){this.dragging||this.flying||this.reduced||(this.vel.x||this.vel.y)&&(this.camera.position.x+=this.vel.x*e,this.camera.position.y+=this.vel.y*e,this.vel=Pc(this.vel,e),this.clamp())}flyTo(e,t,n,r,i={}){this.reduced&&(r=0),this.flying=!0,this.cancellableFlight=i.cancellable??!1;let a=++this.flightId,o={...this.camera.position},s=performance.now();return new Promise(i=>{let c=()=>{if(this.flightId!==a){i(!1);return}let l=r===0?1:Math.min(1,(performance.now()-s)/(r*1e3));if(l<1){let r=Bc(l);this.camera.position.set(o.x+(e-o.x)*r,o.y+(t-o.y)*r,o.z+(n-o.z)*r),requestAnimationFrame(c)}else this.camera.position.set(e,t,n),this.flying=!1,this.cancellableFlight=!1,i(!0)};c()})}cancelFlight(){this.flying&&this.cancellableFlight&&(this.flying=!1,this.cancellableFlight=!1,this.flightId++)}dispose(){this.ac.abort()}};function Hc(e,t,n,r){let i=-1,a=1/0;for(let r=0;r<n;r++){let n=t(r),o=Math.hypot(n.x-e.x,n.y-e.y);o<a&&(a=o,i=r)}return a<=r?i:null}var Uc=class{overlay;artworks;els=[];constructor(e,t){this.overlay=e,this.artworks=t;for(let t=0;t<12;t++){let t=document.createElement(`div`);t.className=`sprite-label`,t.style.display=`none`,e.appendChild(t),this.els.push(t)}}hide(){this.els.forEach(e=>e.style.display=`none`)}update(e,t,n,r=40){if(e.position.z>=r){this.els.forEach(e=>e.style.display=`none`);return}let i=zc(e,t.clientHeight),a=this.artworks.map((t,r)=>{let i=n(r);return{a:t,p:i,d:Math.hypot(i.x-e.position.x,i.y-e.position.y)}}).sort((e,t)=>e.d-t.d).slice(0,12);this.els.forEach((n,r)=>{let o=a[r];if(!o){n.style.display=`none`;return}let s=t.clientWidth/2+(o.p.x-e.position.x)/i,c=t.clientHeight/2-(o.p.y-e.position.y)/i;n.textContent=`${String(o.a.day).padStart(3,`0`)} · ${o.a.title}`,n.style.display=`block`,n.style.transform=`translate(${Math.round(s)}px, ${Math.round(c+32)}px) translateX(-50%)`})}};function Wc(e){let t=e.replace(/\/+$/,``),n=t.match(/^\/day\/([0-9]{3}-[a-z0-9-]+)$/);return n?{kind:`day`,slug:n[1]}:t===`/today`?{kind:`today`}:t===`/attractors`||t===`/index`?{kind:`attractors`}:t===`/sound`||t===`/music`?{kind:`sound`}:t===`/story`||t===`/about`?{kind:`story`}:{kind:`home`}}function Gc(e){switch(e.kind){case`home`:return`/`;case`day`:return`/day/${e.slug}/`;case`today`:return`/today/`;case`attractors`:return`/attractors/`;case`sound`:return`/sound/`;case`story`:return`/story/`}}var Kc=class{onChange;constructor(e){this.onChange=e,window.addEventListener(`popstate`,()=>this.onChange(this.current()))}current(){return Wc(location.pathname)}go(e,t={}){Gc(e)!==location.pathname&&(t.replace?history.replaceState(null,``,Gc(e)):history.pushState(null,``,Gc(e))),this.onChange(e)}},qc={system:`lorenz`,paramCount:4,isDiscreteMap:!1,disturbIndices:[0,1],glslStep:`
  ...
  `},Jc={system:`lorenz_84`,paramCount:5,isDiscreteMap:!1,disturbIndices:[0,2],glslStep:`
  ...
  `},Yc={system:`pickover`,paramCount:4,isDiscreteMap:!0,disturbIndices:[0,2],glslStep:`
    vec3 stepAttractor(vec3 p, float params[4]) {
      float A = params[0];
      float B = params[1];
      float C = params[2];
  ...
  `},Xc={system:`polynomial_a`,paramCount:3,isDiscreteMap:!0,disturbIndices:[0,1,2],glslStep:`
  ...
  `},Zc={system:`polynomial_b`,paramCount:6,isDiscreteMap:!0,disturbIndices:[0,1,2,3,4,5],glslStep:`
  ...
  `},Qc={system:`chaotic_flow`,paramCount:22,isDiscreteMap:!1,disturbIndices:[0,7,14],glslStep:`
  ...
  `},$c={system:`polynomial_c`,paramCount:18,isDiscreteMap:!0,disturbIndices:[1,7,13],glslStep:`
  ...
  `};function el(e){let t=Array(40).fill(0),n;n=e.length<=21?0:e.length<=24?1:2;for(let n=0;n<e.length&&n<39;n++)t[n]=e[n];return t[39]=n,t}var tl={system:`polynomial_func`,paramCount:40,isDiscreteMap:!0,disturbIndices:[0,1,2,3],glslStep:`
  ...
  `},nl={system:`polynomial_sprott`,paramCount:168,isDiscreteMap:!0,disturbIndices:[0,56,112],glslStep:`
  ...
  `};function rl(e,t){let n=Array(9);for(let r=0;r<3;r++)for(let i=0;i<3;i++)n[r*3+i]=e[r*3]*t[i]+e[r*3+1]*t[3+i]+e[r*3+2]*t[6+i];return n}function il(e){let t=[],n=[];for(let r=0;r+16<=e.length;r+=16){let[i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y]=e.slice(r,r+16),b=Math.cos,x=Math.sin,S=[b(o),-x(o),0,x(o),b(o),0,0,0,1],C=[b(a),0,x(a),0,1,0,-x(a),0,b(a)],w=[1,0,0,0,b(i),-x(i),0,x(i),b(i)],T=rl(rl(S,C),w),E=[1,u,d,f,1,p,m,h,1],D=[s,0,0,0,c,0,0,0,l],O=rl(rl(T,E),D);t.push(...O,g,_,v,0),n.push(y)}let r=n.reduce((e,t)=>e+Math.max(0,t),0)||1;return n.forEach((e,n)=>{t[n*13+12]=Math.max(0,e)/r}),t}function al(e,t,n){let r=Math.floor(e.length/13),i=n(),a=(r-1)*13;for(let t=0;t<r;t++)if(i-=e[t*13+12],i<=0){a=t*13;break}let o=e[a]*t.x+e[a+1]*t.y+e[a+2]*t.z+e[a+9],s=e[a+3]*t.x+e[a+4]*t.y+e[a+5]*t.z+e[a+10],c=e[a+6]*t.x+e[a+7]*t.y+e[a+8]*t.z+e[a+11];t.x=o,t.y=s,t.z=c}var ol={system:`ifs`,paramCount:`variable`,isDiscreteMap:!0,disturbStride:{stride:13,offsets:[9,10,11]},glslStep:`
  ...
  `},sl={system:`icon`,paramCount:6,isDiscreteMap:!0,disturbIndices:[3,1],glslStep:`
    vec3 stepAttractor(vec3 p, float params[6]) {
  ...
  `},cl={system:`unravel`,paramCount:7,isDiscreteMap:!0,disturbIndices:[0,1],glslStep:`
  ...
  `};function ll(e,t,n){let r=Math.max(2,Math.round(e[0])),i=e[3],a=e[1],o=e[2]*Math.cos(i),s=e[2]*Math.sin(i),c=t.x-a,l=t.y-o,u=t.z-s,d=t.w,f=Math.hypot(c,l,u,d),p=Math.hypot(l,u,d),m=Math.atan2(p,c),h=p>1e-12?l/p:1,g=p>1e-12?u/p:0,_=p>1e-12?d/p:0,v=Math.floor(n()*r),y=(m+2*Math.PI*v)/r,b=f**(1/r);t.x=b*Math.cos(y);let x=b*Math.sin(y);t.y=x*h,t.z=x*g,t.w=x*_}var ul={lorenz:qc,lorenz_84:Jc,pickover:Yc,polynomial_a:Xc,polynomial_b:Zc,chaotic_flow:Qc,polynomial_c:$c,polynomial_func:tl,polynomial_sprott:nl,ifs:ol,icon:sl,unravel:cl,julia:{system:`julia`,paramCount:4,isDiscreteMap:!0,stateW:!0,disturbIndices:[1,2],glslStep:`
...
void main() {
...
}`,vl=e=>`params[${e}] += uPerturbation * (0.15 * sin(dot(uv, vec2(12.9898, 78.233)) * 43758.5453 + float(${e})));`;function yl(e,t){let n;if(e.disturbStride){let{stride:r,offsets:i}=e.disturbStride;n=[];for(let e=0;e*r<t;e++)for(let t of i)n.push(vl(e*r+t))}else n=(e.disturbIndices??[]).map(vl);let r=e.glslStep.replaceAll(`__N__`,String(t)),i=e.stateW===!0,a=e.randomReseed;return`
  ...
  `}function bl(e,t){if(t&&t.points.length>=3){let n=Math.floor(t.points.length/3),r=t.jitter;for(let i=0;i<e.length;i+=4){let a=Math.floor(Math.random()*n)*3;e[i]=t.points[a]+(Math.random()-.5)*r,e[i+1]=t.points[a+1]+(Math.random()-.5)*r,e[i+2]=t.points[a+2]+(Math.random()-.5)*r,e[i+3]=1}return}for(let t=0;t<e.length;t+=4)e[t]=(Math.random()-.5)*.1,e[t+1]=(Math.random()-.5)*.1,e[t+2]=(Math.random()-.5)*.1,e[t+3]=1}var xl=class{points;gpuCompute;positionVariable;material;tier;constructor(e,t,n,r,i,a){this.tier=r,this.gpuCompute=new hl(r,r,e);let o=this.gpuCompute.createTexture(),s=o.image.data;bl(s,i);let c=t.paramCount===`variable`?n.length:t.paramCount;this.positionVariable=this.gpuCompute.addVariable(`texturePosition`,yl(t,c),o),this.gpuCompute.setVariableDependencies(this.positionVariable,[this.positionVariable]),this.positionVariable.material.uniforms.uParamsA={value:n.slice()},this.positionVariable.material.uniforms.uParamsB={value:n.slice()},this.positionVariable.material.uniforms.uMorphMix={value:0},this.positionVariable.material.uniforms.uPerturbation={value:0},this.positionVariable.material.uniforms.uFrame={value:0};let l=this.gpuCompute.init();if(l!==null)throw Error(`GPUComputationRenderer init failed: ${l}`);for(let e=0;e<150;e++)this.positionVariable.material.uniforms.uFrame.value=e,this.gpuCompute.compute();let u=r*r,d=r>=2048?1.2:r>=1024?1.6:3.5,f=Math.min(1,Math.max(.12,1024*1024*1.6*1.6*.5*1.7/(u*d*d))),p=new rr;p.setAttribute(`position`,new Hn(new Float32Array(u*3),3)),this.material=new oi({vertexShader:gl,fragmentShader:_l,transparent:!0,blending:2,depthWrite:!1,uniforms:{uPosition:{value:this.gpuCompute.getCurrentRenderTarget(this.positionVariable).texture},uTexSize:{value:r},uPointSize:{value:d},uAlpha:{value:f},uBrightness:{value:1},uCalibration:{value:1},uTint:{value:a?a.clone():new Z(1,1,1)}}}),this.points=new Wr(p,this.material),this.points.frustumCulled=!1}setParams(e){this.positionVariable.material.uniforms.uParamsA.value=e.slice()}setMorphTarget(e,t){e&&(this.positionVariable.material.uniforms.uParamsB.value=e.slice()),this.positionVariable.material.uniforms.uMorphMix.value=t}setPerturbation(e){this.positionVariable.material.uniforms.uPerturbation.value=e}calibrate(e,t){let n=this.material.uniforms.uTint.value;if(n.r>.99&&n.g>.99&&n.b>.99)return;let r=t.aspect||1,i=Math.max(1,Math.round(Math.sqrt(512*512/r))),a=Math.max(1,Math.round(i*r)),o=null;try{o=new Ct(a,i);let n=new ln;n.add(this.points);let r=e.getRenderTarget(),s=new Uint8Array(a*i*4);for(let r=0;r<3;r++){e.setRenderTarget(o),e.clear(),e.render(n,t),e.readRenderTargetPixels(o,0,0,a,i,s);let r=0,c=0;for(let e=0;e<a*i;e++){let t=s[e*4],n=s[e*4+1],i=s[e*4+2];t<4&&n<4&&i<4||(r++,t>250&&n>250&&i>250&&c++)}if(r<8)break;let l=c/r;if(l<.35)break;this.material.uniforms.uCalibration.value=Math.max(.02,this.material.uniforms.uCalibration.value*(1-l))}e.setRenderTarget(r)}catch{}finally{o?.dispose()}}setBrightness(e){this.material.uniforms.uBrightness.value=Math.max(.1,e)}compute(){let e=this.positionVariable.material.uniforms.uFrame;e.value=(e.value+1)%1048576,this.gpuCompute.compute(),this.material.uniforms.uPosition.value=this.gpuCompute.getCurrentRenderTarget(this.positionVariable).texture}dispose(){this.points.removeFromParent(),this.points.geometry.dispose(),this.material.dispose(),this.gpuCompute.dispose()}},Sl=.12;function Cl(e){if(e.length===0)return new Z(1,1,1);let t=e.map(e=>{let t=new Z(e),n={h:0,s:0,l:0};return t.getHSL(n),n}),n=t.filter(e=>e.l>.08&&e.l<.95),r=n.length>0?n:t,i=r.reduce((e,t)=>t.s>e.s?t:e,r[0]);if(i.s<Sl)return new Z(1,1,1);let a=Math.min(.7,Math.max(.45,i.l));return new Z().setHSL(i.h,Math.max(i.s,.35),a)}function wl(e){return e.webgl2?e.isMobile?256:(e.deviceMemoryGB??0)>=8?2048:1024:null}function Tl(e){return{azimuth:0,elevation:0,radius:10,target:e}}function El(e,t,n){let r=e.azimuth-t*.005,i=Math.max(-1.4,Math.min(1.4,e.elevation-n*.005));return{...e,azimuth:r,elevation:i}}function Dl(e,t){let n=Math.max(3,Math.min(30,e.radius*Math.exp(t*.0015)));return{...e,radius:n}}function Ol(e){let{azimuth:t,elevation:n,radius:r,target:i}=e;return{x:i.x+r*Math.cos(n)*Math.sin(t),y:i.y+r*Math.sin(n),z:i.z+r*Math.cos(n)*Math.cos(t)}}var kl=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],Al=new Set([34,5]);function jl(e,t){return(e-1+t+365)%365+1}function Ml(e){let{month:t,date:n}=Dc(e.day);return`${String(e.day).padStart(3,`0`)}/365 · ${e.title} · ${kl[t-1]} ${n}, 2010`}var Nl={lorenz:`Lorenz`,lorenz_84:`Lorenz-84`,icon:`Field–Golubitsky icon`,pickover:`Pickover`,chaotic_flow:`Chaotic flow`,polynomial_a:`Polynomial A`,polynomial_b:`Polynomial B`,polynomial_c:`Polynomial C`,polynomial_func:`Polynomial`,polynomial_sprott:`Polynomial (Sprott)`,julia:`Julia (quaternion)`,ifs:`IFS`,unravel:`Unravel`,incendia_ifs:`Incendia IFS`,incendia_flow:`Incendia flow`};function Pl(e){return e?Nl[e]??null:null}function Fl(e,t){return!e||!t||e.system===`static-only`||t.system===`static-only`||e.system!==t.system||e.params&&t.params&&(e.params.length!==t.params.length||e.system===`icon`&&e.params[0]!==t.params[0]||e.system===`julia`&&e.params[0]!==t.params[0])?`dissolve`:`morph`}function Il(e,t){return e===`ifs`?il(t):e===`polynomial_func`?el(t):t}function Ll(e,t,n,r){for(let t=0;t<n;t++)e();let i=1/0,a=-1/0,o=1/0,s=-1/0,c=1/0,l=-1/0,u=Math.max(1,Math.floor(r/4096)),d=[];for(let n=0;n<r&&(e(),!(!isFinite(t.x)||!isFinite(t.y)||!isFinite(t.z)));n++)i=Math.min(i,t.x),a=Math.max(a,t.x),o=Math.min(o,t.y),s=Math.max(s,t.y),c=Math.min(c,t.z),l=Math.max(l,t.z),n%u===0&&d.push(t.x,t.y,t.z);let f=Math.max(isFinite(a)&&isFinite(i)?(a-i)/2:0,isFinite(s)&&isFinite(o)?(s-o)/2:0,isFinite(l)&&isFinite(c)?(l-c)/2:0),p=f>.001?4/f:1,m=isFinite(i)&&isFinite(a)?(i+a)/2:0,h=isFinite(o)&&isFinite(s)?(o+s)/2:0,g=isFinite(c)&&isFinite(l)?(c+l)/2:0,_=f>.001?f*2*.01:.05;return{scale:p,centerX:m,centerY:h,centerZ:g,seed:{points:Float32Array.from(d),jitter:_}}}function Rl(e){let[t,n,r,i,a]=e,o={x:.1,y:.1,z:.1};return Ll(()=>{let e=-o.y*o.y-o.z*o.z-t*o.x+t*r,s=o.x*o.y-n*o.x*o.z-o.y+i,c=n*o.x*o.y+o.x*o.z-o.z;o.x+=e*a,o.y+=s*a,o.z+=c*a},o,2e3,2e3)}function zl(e){let t=e,n=t[21],r=(e,t,n,r)=>{let i=Math.round(e);return i<=0?1:i===1?t:i===2?n:r},i={x:.1,y:.1,z:.1};return Ll(()=>{let{x:e,y:a,z:o}=i,s=t[0]*r(t[1],e,a,o)*e+t[2]*r(t[3],e,a,o)*a+t[4]*r(t[5],e,a,o)*o+t[6],c=t[7]*r(t[8],e,a,o)*e+t[9]*r(t[10],e,a,o)*a+t[11]*r(t[12],e,a,o)*o+t[13],l=t[14]*r(t[15],e,a,o)*e+t[16]*r(t[17],e,a,o)*a+t[18]*r(t[19],e,a,o)*o+t[20];i.x+=s*n,i.y+=c*n,i.z+=l*n},i,2e3,4e3)}function Bl(e){let t=e,n={x:.1,y:.1,z:.1};return Ll(()=>{let{x:e,y:r,z:i}=n,a=t[0]+e*(t[1]+t[2]*e+t[3]*r)+r*(t[4]+t[5]*r),o=t[6]+r*(t[7]+t[8]*r+t[9]*i)+i*(t[10]+t[11]*i),s=t[12]+i*(t[13]+t[14]*i+t[15]*e)+e*(t[16]+t[17]*e);n.x=a,n.y=o,n.z=s},n,3e3,3e3)}function Vl(e){let[t,n,r]=e,i={x:0,y:0,z:0};return Ll(()=>{let{x:e,y:a,z:o}=i,s=t+a-o*a,c=n+o-e*o,l=r+e-a*e;i.x=s,i.y=c,i.z=l},i,3e3,3e3)}function Hl(e){let[t,n,r,i,a,o]=e,s={x:0,y:0,z:0};return Ll(()=>{let{x:e,y:c,z:l}=s,u=t+c-l*(n+c),d=r+l-e*(i+l),f=a+e-c*(o+e);s.x=u,s.y=d,s.z=f},s,3e3,3e3)}function Ul(e){let t=el(e),n=t[39],r={x:.1,y:.1,z:.1};return Ll(()=>{let{x:e,y:i,z:a}=r,o=Math.abs(e),s=Math.abs(i),c=Math.abs(a),l,u,d;n<.5?(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*o+t[5]*s+t[6]*c,u=t[7]+t[8]*e+t[9]*i+t[10]*a+t[11]*o+t[12]*s+t[13]*c,d=t[14]+t[15]*e+t[16]*i+t[17]*a+t[18]*o+t[19]*s+t[20]*c):n<1.5?(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*o+t[5]*s+t[6]*c**+t[7],u=t[8]+t[9]*e+t[10]*i+t[11]*a+t[12]*o+t[13]*s+t[14]*c**+t[15],d=t[16]+t[17]*e+t[18]*i+t[19]*a+t[20]*o+t[21]*s+t[22]*c**+t[23]):(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*Math.sin(t[5]*t[6]*e)+t[7]*Math.sin(t[8]*t[9]*i)+t[10]*Math.sin(t[11]*t[12]*a),u=t[13]+t[14]*e+t[15]*i+t[16]*a+t[17]*Math.sin(t[18]*t[19]*e)+t[20]*Math.sin(t[21]*t[22]*i)+t[23]*Math.sin(t[24]*t[25]*a),d=t[26]+t[27]*e+t[28]*i+t[29]*a+t[30]*Math.sin(t[31]*t[32]*e)+t[33]*Math.sin(t[34]*t[35]*i)+t[36]*Math.sin(t[37]*t[38]*a)),r.x=l,r.y=u,r.z=d},r,3e3,3e3)}function Wl(e){let t=il(e),n={x:.1,y:.1,z:.1};return Ll(()=>al(t,n,Math.random),n,200,4e3)}function Gl(e){let t={x:.1,y:.1,z:.1};return Ll(()=>al(e,t,Math.random),t,200,4e3)}function Kl(e){let t=Math.round(e[0]),[,n,r,i,a,o]=e,s={x:.1,y:.1,z:0};return Ll(()=>{let e=1,c=0;for(let n=0;n<t-1;n++){let t=e*s.x-c*s.y;c=e*s.y+c*s.x,e=t}let l=i+n*(s.x*s.x+s.y*s.y)+r*(s.x*e-s.y*c),u=l*s.x+a*e-o*s.y,d=l*s.y-a*c+o*s.x;s.x=u,s.y=d,s.z=Math.abs(l)},s,500,4e3)}function ql(e){let[t,n,r,i,a,o,s]=e,c={x:.1,y:.1,z:.1};return Ll(()=>{let e=i*(c.z+t),l=a*(c.x+n),u=o*(c.y+r),d=Math.hypot(e,l,u);if(d>s&&s>0){let t=1-s*(Math.floor(d/s)+1)/d;e*=t,l*=t,u*=t}c.x=e,c.y=l,c.z=u},c,500,4e3)}function Jl(e){let t={x:.5,y:.3,z:.2,w:.1},n={x:t.x,y:t.y,z:t.z};return Ll(()=>{ll(e,t,Math.random),n.x=t.x,n.y=t.y,n.z=t.z},n,200,4e3)}var Yl=4,Xl=3,Zl=[1,2,4,8,16,32,64];function Ql(e){let t=Xl*Math.hypot(e[9],e[10],e[11])||.1,n=[],r=Zl[Zl.length-1];for(let t=0;t<200;t++){let t={x:(Math.random()-.5)*4,y:(Math.random()-.5)*4,z:(Math.random()-.5)*4},i=0;for(let a=1;a<=r;a++)al(e,t,Math.random),a===Zl[i]&&(i++,Number.isFinite(t.x)&&Number.isFinite(t.y)&&Number.isFinite(t.z)&&n.push(t.x,t.y,t.z))}return{scale:Yl/t,centerX:0,centerY:0,centerZ:0,seed:{points:Float32Array.from(n),jitter:t*.02}}}var $l=.2,eu=3.2,tu={lorenz:e=>({scale:$l,centerX:0,centerY:0,centerZ:e.length>=2?e[1]-1:0}),pickover:()=>({scale:eu,centerX:0,centerY:0,centerZ:0}),lorenz_84:e=>({...Rl(e),seed:void 0}),chaotic_flow:zl,polynomial_c:Bl,polynomial_func:Ul,polynomial_a:Vl,polynomial_b:Hl,ifs:Wl,incendia_ifs:Gl,incendia_flow:Ql,icon:Kl,unravel:ql,julia:Jl},nu=`la-brightness`;function ru(){let e=Number(localStorage.getItem(nu));return Number.isFinite(e)&&e>0?e:1}var iu=class{overlay;onNavigate;onClose;root;img;sources;caption;prevBtn;nextBtn;listenBtn;audioEl=new Audio;current=null;bySlug;byDay;live_;attractorsByDay=new Map;tier=null;liveAttractor=null;orbit=null;orbitDragging=!1;orbitLast={x:0,y:0};orbitMoved=0;disturbHeld=!1;disturbAmount=0;brightness=ru();constructor(e,t,n,r,i){this.overlay=e,this.onNavigate=n,this.onClose=r,this.bySlug=new Map(t.map(e=>[e.slug,e])),this.byDay=new Map(t.map(e=>[e.day,e])),this.root=document.createElement(`div`),this.root.className=`piece hidden`,this.root.innerHTML=`
      ...
      <button class="piece-close" aria-label="Return to the constellation" title="Return to the constellation"><span class="glyph">×</span> Sky</button>`,e.appendChild(this.root);let a=this.root.querySelector(`.piece-backdrop`),[o,s]=this.root.querySelectorAll(`source`);this.sources={avif:o,webp:s},this.img=this.root.querySelector(`img`),this.caption=this.root.querySelector(`figcaption`),this.prevBtn=this.root.querySelector(`.prev`),this.nextBtn=this.root.querySelector(`.next`),this.listenBtn=document.createElement(`button`),this.listenBtn.className=`piece-listen`,this.listenBtn.addEventListener(`click`,()=>{this.audioEl.paused?(this.audioEl.play().catch(()=>{this.listenBtn.textContent=`▶ Listen`}),this.listenBtn.textContent=`❚❚ Pause`):(this.audioEl.pause(),this.listenBtn.textContent=`▶ Listen`)}),this.audioEl.addEventListener(`ended`,()=>{this.listenBtn.textContent=`▶ Listen`}),this.root.querySelector(`.prev`).addEventListener(`click`,()=>this.nav(-1)),this.root.querySelector(`.next`).addEventListener(`click`,()=>this.nav(1)),this.root.querySelector(`.piece-close`).addEventListener(`click`,()=>this.requestClose()),this.root.addEventListener(`click`,e=>{(e.target===this.root||e.target===a)&&this.requestClose()}),addEventListener(`keydown`,e=>{this.isOpen()&&(e.key===`Escape`&&this.requestClose(),e.key===`ArrowLeft`&&this.nav(-1),e.key===`ArrowRight`&&this.nav(1))}),this.live_=i,i.brightnessSlider.value=String(this.brightness),i.brightnessSlider.addEventListener(`input`,()=>{this.brightness=Number(i.brightnessSlider.value),localStorage.setItem(nu,String(this.brightness)),this.liveAttractor?.setBrightness(this.brightness)}),this.attractorsByDay=new Map(i.attractors.map(e=>[e.day,e])),this.tier=wl({webgl2:i.renderer.capabilities.isWebGL2,isMobile:/Mobi|Android/i.test(navigator.userAgent),deviceMemoryGB:navigator.deviceMemory}),this.bindOrbitEvents()}bindOrbitEvents(){let e=this.live_.canvas;e.addEventListener(`pointerdown`,e=>{this.liveAttractor&&(e.target.closest(`button`)||(this.orbitDragging=!0,this.orbitLast={x:e.clientX,y:e.clientY},this.orbitMoved=0,this.disturbHeld=!0))}),addEventListener(`pointermove`,e=>{if(!this.liveAttractor||!this.orbitDragging||!this.orbit)return;let t=e.clientX-this.orbitLast.x,n=e.clientY-this.orbitLast.y;this.orbit=El(this.orbit,t,n),this.orbitLast={x:e.clientX,y:e.clientY},this.orbitMoved+=Math.hypot(t,n),this.orbitMoved>5&&(this.disturbHeld=!1)}),addEventListener(`pointerup`,()=>{this.orbitDragging=!1,this.disturbHeld=!1}),e.addEventListener(`wheel`,e=>{!this.liveAttractor||!this.orbit||(e.preventDefault(),this.orbit=Dl(this.orbit,e.deltaY))},{passive:!1})}nav(e){if(!this.current)return;let t=this.byDay.get(jl(this.current.day,e)),n=this.attractorsByDay.get(this.current.day),r=this.attractorsByDay.get(t.day);if(Fl(n?{day:n.day,system:n.system,params:n.params}:null,r?{day:r.day,system:r.system,params:r.params}:null)===`morph`&&this.liveAttractor&&r?.params){let e=this.liveAttractor,t=Il(r.system,r.params);e.setMorphTarget(t,0);let n=performance.now(),i=()=>{if(this.liveAttractor!==e)return;let r=Math.min(1,(performance.now()-n)/800);e.setMorphTarget(t,r),r<1?requestAnimationFrame(i):(e.setParams(t),e.setMorphTarget(null,0))};requestAnimationFrame(i)}this.orbit=null,this.audioEl.pause(),this.onNavigate(t.slug)}requestClose(){this.close(),this.onClose()}open(e){let t=this.bySlug.get(e);if(!t)return;this.current=t;let n=e=>`${Tc(t.slug,1024,e)} 1024w, ${Tc(t.slug,2e3,e)} 2000w`;this.sources.avif.srcset=n(`avif`),this.sources.webp.srcset=n(`webp`),this.img.srcset=n(`jpg`),this.img.src=Tc(t.slug,1024,`jpg`),this.img.alt=`${t.title} — strange attractor, day ${t.day} of 365, 2010`,this.caption.textContent=Ml(t);let r=this.byDay.get(jl(t.day,-1)),i=this.byDay.get(jl(t.day,1));this.prevBtn.dataset.label=`day ${String(r.day).padStart(3,`0`)}`,this.prevBtn.title=`day ${String(r.day).padStart(3,`0`)} · ${r.title}`,this.prevBtn.setAttribute(`aria-label`,`Previous — day ${r.day}: ${r.title}`),this.nextBtn.dataset.label=`day ${String(i.day).padStart(3,`0`)}`,this.nextBtn.title=`day ${String(i.day).padStart(3,`0`)} · ${i.title}`,this.nextBtn.setAttribute(`aria-label`,`Next — day ${i.day}: ${i.title}`);let a=Pl(this.attractorsByDay.get(t.day)?.system);if(a){let e=document.createElement(`span`);e.className=`caption-meta`,e.textContent=a,this.caption.append(document.createElement(`br`),e)}this.audioEl.pause(),t.audio?(this.audioEl.src=t.audio,this.listenBtn.textContent=`▶ Listen`,this.caption.append(document.createElement(`br`),this.listenBtn)):this.audioEl.removeAttribute(`src`),this.root.classList.remove(`hidden`);for(let e of[1,-1]){let n=this.byDay.get(jl(t.day,e));new Image().src=Tc(n.slug,1024,`jpg`)}this.liveAttractor?.dispose(),this.liveAttractor=null;let o=this.attractorsByDay.get(t.day),s=o&&o.system!==`static-only`?dl(o.system):null;if(s&&o?.params&&this.tier&&!Al.has(t.day))try{let e=tu[o.system]?.(o.params)??{scale:1,centerX:0,centerY:0,centerZ:0},n=e.seed&&e.seed.points.length>=3?e.seed:void 0,r=Il(o.system,o.params),i=Cl(t.palette);if(this.liveAttractor=new xl(this.live_.renderer,s,r,this.tier,n,i),!s.isDiscreteMap){let e=o.params[o.params.length-1];if(e>0){let t=Math.min(2e4,Math.ceil(20/e));for(let e=0;e<t;e++)this.liveAttractor.compute()}}this.liveAttractor.points.scale.setScalar(e.scale),this.liveAttractor.points.position.set(t.x-e.scale*e.centerX,t.y-e.scale*e.centerY,8-e.scale*e.centerZ),this.orbit=Tl({x:t.x,y:t.y,z:8});let a=Ol(this.orbit);this.live_.camera.position.set(a.x,a.y,a.z),this.live_.camera.lookAt(this.orbit.target.x,this.orbit.target.y,this.orbit.target.z),this.liveAttractor.calibrate(this.live_.renderer,this.live_.camera),this.liveAttractor.setBrightness(this.brightness),this.live_.liveScene.add(this.liveAttractor.points),this.live_.controls.setEnabled(!1)}catch(e){console.error(`live attractor init failed, falling back to static`,e),this.liveAttractor=null,this.orbit=null}this.live_.modeToggle.style.display=this.liveAttractor?`flex`:`none`,this.live_.brightnessSlider.style.display=this.liveAttractor?`block`:`none`,this.root.classList.toggle(`live-active`,!!this.liveAttractor)}close(){this.audioEl.pause(),this.liveAttractor?.dispose(),this.liveAttractor=null,this.orbit=null,this.disturbHeld=!1,this.disturbAmount=0,this.live_.controls.setEnabled(!0),this.live_.modeToggle.style.display=`none`,this.live_.brightnessSlider.style.display=`none`,this.root.classList.remove(`live-active`),this.root.classList.add(`hidden`),this.current=null,this.live_.camera.quaternion.identity()}isOpen(){return this.current!==null}hasLiveSupport(){return this.tier!==null}toggleHideStatic(){return this.root.classList.toggle(`hide-static`)}isHidingStatic(){return this.root.classList.contains(`hide-static`)}currentSystem(){return this.current?this.attractorsByDay.get(this.current.day)?.system:void 0}isShowingLiveFullscreen(){return!!this.liveAttractor&&this.root.classList.contains(`hide-static`)}updateDisturb(e){if(!this.liveAttractor)return;let t=+!!this.disturbHeld,n=this.disturbHeld?1/.3:1/1.5;this.disturbAmount+=(t-this.disturbAmount)*Math.min(1,n*e),this.liveAttractor.setPerturbation(this.disturbAmount)}render(e){if(this.liveAttractor&&this.orbit){let e=Ol(this.orbit);this.live_.camera.position.set(e.x,e.y,e.z),this.live_.camera.lookAt(this.orbit.target.x,this.orbit.target.y,this.orbit.target.z)}this.updateDisturb(e),this.liveAttractor?.compute()}},au=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`];function ou(e,t){let n=t.trim().toLowerCase();if(!n)return[];let r=[];if(/^\d{1,3}$/.test(n)){let t=parseInt(n,10),i=e.find(e=>e.day===t);i&&r.push(i)}for(let t of e){if(r.length>=8)break;!r.includes(t)&&t.title.toLowerCase().includes(n)&&r.push(t)}return r.slice(0,8)}var su=class{artworks;onPick;root;results;openState=!1;constructor(e,t,n){this.artworks=t,this.onPick=n,this.root=document.createElement(`div`),this.root.className=`indexview hidden`;let r=document.createElement(`input`);r.type=`search`,r.placeholder=`day number or title…`,r.setAttribute(`aria-label`,`Search artworks`),this.results=document.createElement(`div`),this.results.className=`index-results`,this.root.append(r,this.results),r.addEventListener(`input`,()=>this.renderResults(ou(this.artworks,r.value))),new Map(t.map(e=>[e.day,e]));for(let e=0;e<12;e++){let n=document.createElement(`h2`);n.textContent=au[e];let r=document.createElement(`div`);r.className=`month-grid`,this.root.append(n,r);for(let n of t)Dc(n.day).month===e+1&&r.appendChild(this.cell(n))}e.appendChild(this.root)}cell(e){let t=document.createElement(`a`);t.className=`day-cell`,t.href=`/day/${e.slug}/`,t.title=`${String(e.day).padStart(3,`0`)} · ${e.title}`;let n=document.createElement(`img`);n.loading=`lazy`,n.src=Tc(e.slug,256,`jpg`),n.alt=e.title;let r=document.createElement(`span`);return r.textContent=String(Dc(e.day).date),t.append(n,r),t.addEventListener(`click`,t=>{t.preventDefault(),this.onPick(e.slug)}),t}renderResults(e){this.results.innerHTML=``;for(let t of e){let e=document.createElement(`a`);e.href=`/day/${t.slug}/`,e.textContent=`${String(t.day).padStart(3,`0`)} · ${t.title}`,e.addEventListener(`click`,e=>{e.preventDefault(),this.onPick(t.slug)}),this.results.appendChild(e)}}open(){this.openState=!0,this.root.classList.remove(`hidden`)}close(){this.openState=!1,this.root.classList.add(`hidden`)}isOpen(){return this.openState}},cu=140,lu=60,uu=class{artworks;cv;ctx;dotColors;constructor(e,t,n){this.artworks=t,this.cv=document.createElement(`canvas`),this.cv.id=`minimap`,this.cv.width=this.cv.height=cu*2,e.appendChild(this.cv),this.ctx=this.cv.getContext(`2d`),this.dotColors=t.map(e=>`#`+Cl(e.palette).getHexString()),this.cv.addEventListener(`click`,e=>{let t=this.cv.getBoundingClientRect();n(((e.clientX-t.left)/cu-.5)*2*lu,-((e.clientY-t.top)/cu-.5)*2*lu)})}update(e,t,n){let r=this.ctx,i=cu*2;r.clearRect(0,0,i,i),r.fillStyle=`rgba(10,12,18,0.85)`,r.fillRect(0,0,i,i),r.strokeStyle=`rgba(255,255,255,0.15)`,r.lineWidth=1,r.strokeRect(.5,.5,i-1,i-1);let a=e=>(e/lu/2+.5)*i,o=e=>(-e/lu/2+.5)*i;this.artworks.forEach((e,t)=>{let i=n(t);r.fillStyle=this.dotColors[t],r.fillRect(a(i.x)-1.5,o(i.y)-1.5,3,3)});let s=zc(e,t.clientHeight),c=t.clientWidth*s,l=t.clientHeight*s;r.strokeStyle=`#cfd3dc`,r.lineWidth=2,r.strokeRect(a(e.position.x-c/2),o(e.position.y+l/2),c/lu/2*i,l/lu/2*i)}};async function du(){return fetch(Sc(`/data/music.json`)).then(e=>e.json())}function fu(e){let t=[{label:`Apple Music`,url:e.appleMusicUrl}];return e.youtubeUrl&&t.push({label:`YouTube`,url:e.youtubeUrl}),t}var pu=class{data;onClose;root;openState=!1;constructor(e,t,n){this.data=t,this.onClose=n,this.root=document.createElement(`div`),this.root.className=`musicview hidden`,this.root.innerHTML=`
      ...
      </div>`,e.appendChild(this.root),this.root.querySelector(`.story-close`).addEventListener(`click`,()=>this.requestClose()),this.root.addEventListener(`click`,e=>{e.target===this.root&&this.requestClose()}),addEventListener(`keydown`,e=>{this.isOpen()&&e.key===`Escape`&&this.requestClose()})}requestClose(){this.close(),this.onClose()}open(){this.openState=!0,this.root.classList.remove(`hidden`)}close(){this.openState=!1,this.root.classList.add(`hidden`)}isOpen(){return this.openState}},hu=[{kind:`today`,label:`Today`,title:`Today — this date's attractor (or press t)`},{kind:`attractors`,label:`Attractors`,title:`Attractors — browse all 365 days (or press /)`},{kind:`sound`,label:`Sound`,title:`Sound — music from the attractors`},{kind:`story`,label:`Story`,title:`Story — one attractor a day, 2010`}],gu=class{root;links=new Map;constructor(e,t,n){this.root=document.createElement(`nav`),this.root.id=`nav-row`;for(let e of hu){if(e.kind===`sound`&&!n.hasSound)continue;let r=document.createElement(`a`);r.href=`/${e.kind}/`,r.textContent=e.label,r.title=e.title,r.addEventListener(`click`,n=>{n.preventDefault(),t(e.kind)}),this.root.appendChild(r),this.links.set(e.kind,r)}e.appendChild(this.root)}setActive(e){for(let[t,n]of this.links)n.classList.toggle(`active`,t===e)}},_u=[31,28,31,30,31,30,31,31,30,31,30,31],vu=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`];function yu(e,t){let n=e===2&&t===29?28:t,r=0;for(let t=0;t<e-1;t++)r+=_u[t];return r+n}function bu(e,t){let n=yu(e.getMonth()+1,e.getDate());return t.find(e=>e.day===n)}function xu(e,t,n=1.6,r=.15){let i=n/r;return{x:e.x,y:e.y,z:i/(2*Math.tan(t*Math.PI/360))}}function Su(e){let{month:t,date:n}=Dc(e.day);return{label:`Day ${String(e.day).padStart(3,`0`)} · ${vu[t-1]} ${n}`,title:e.title}}async function Cu(){let[{artworks:e,atlas:t},n,r]=await Promise.all([Cc(),wc(),du().catch(()=>null)]),i=document.getElementById(`gl`),a=Ac(e),o;try{o=new Nc(i,e,t)}catch(e){console.error(`WebGL unavailable, falling back to static page`,e);return}document.querySelector(`.static-piece`)?.remove(),document.querySelector(`.static-nav`)?.remove();let s=matchMedia(`(prefers-reduced-motion: reduce)`);o.setReducedMotion(s.matches);let c=new Vc(i,o.camera,a,{reducedMotion:s.matches}),l=!1,u=!1,d=()=>{let t=i.clientWidth,n=i.clientHeight;if(!t||!n){requestAnimationFrame(f);return}o.resize();let r=Ic(Ac(e,l?`date`:`likeness`),t/n,o.camera.fov,.85);o.camera.position.set(r.x,r.y,r.z)},f=()=>{c.hasUserMoved()||u||d()};d(),addEventListener(`resize`,()=>{o.resize(),c.hasUserMoved()||d()}),s.addEventListener(`change`,()=>o.setReducedMotion(s.matches));let p=document.getElementById(`overlay`),m=document.createElement(`div`);m.id=`layout-switch`;let h=document.createElement(`button`);h.textContent=`Likeness`,h.title=`Arrange the constellation by visual similarity`;let g=document.createElement(`button`);g.textContent=`Date`,g.title=`Arrange the constellation by calendar date`,m.append(h,g),p.appendChild(m);let _=e=>{h.classList.toggle(`active`,!e),g.classList.toggle(`active`,e),h.setAttribute(`aria-pressed`,String(!e)),g.setAttribute(`aria-pressed`,String(e)),l=e,o.setTimeMix(+!!e),c.hasUserMoved()||d()};h.addEventListener(`click`,()=>_(!1)),g.addEventListener(`click`,()=>_(!0)),_(!1);let v=new uu(p,e,(e,t)=>c.flyTo(e,t,o.camera.position.z,.6)),y=bu(new Date,e),b=e.findIndex(e=>e.day===y.day);o.setHighlight(b);let x=document.createElement(`div`);x.id=`today-caption`;let S=Su(y),C=document.createElement(`small`);C.textContent=S.label;let w=document.createElement(`span`);if(w.textContent=S.title,x.append(C,w),!localStorage.getItem(`la-intro-seen`)){let e=document.createElement(`p`);e.className=`today-hints`,e.textContent=`drag to wander · scroll to dive · click to open`,x.appendChild(e)}p.appendChild(x);let T=()=>{x.classList.remove(`visible`),localStorage.setItem(`la-intro-seen`,`1`)};i.addEventListener(`pointerdown`,T,{once:!0}),i.addEventListener(`wheel`,T,{once:!0});let E=new Uc(p,e),D=null;i.addEventListener(`pointermove`,t=>{D=Hc(c.screenToWorld(t.clientX,t.clientY),e=>o.positionOf(e),e.length,1.2),o.setHover(D),i.style.cursor=D===null?`grab`:`pointer`});let O=document.createElement(`div`);O.id=`mode-toggle`;let k=document.createElement(`button`);k.textContent=`Image`,k.title=`Show the 2010 static render`;let A=document.createElement(`button`);A.textContent=`Orbit`,A.title=`Show only the live attractor`,O.append(k,A);let j=()=>{let e=F.isHidingStatic();k.classList.toggle(`active`,!e),A.classList.toggle(`active`,e),k.setAttribute(`aria-pressed`,String(!e)),A.setAttribute(`aria-pressed`,String(e)),A.textContent=F.currentSystem()===`incendia_flow`?`Flow`:`Orbit`};k.addEventListener(`click`,()=>{F.isHidingStatic()&&(F.toggleHideStatic(),j())}),A.addEventListener(`click`,()=>{F.isHidingStatic()||(F.toggleHideStatic(),j())});let M=document.createElement(`input`);M.id=`brightness-slider`,M.type=`range`,M.min=`0.4`,M.max=`6`,M.step=`0.1`,M.setAttribute(`aria-label`,`Live attractor brightness`);let N=new ln,P=new Map(e.map((e,t)=>[e.slug,t])),F=new iu(p,e,e=>L.go({kind:`day`,slug:e}),()=>L.go({kind:`home`}),{attractors:n,renderer:o.renderer,liveScene:N,camera:o.camera,canvas:i,controls:c,modeToggle:O,brightnessSlider:M});p.appendChild(O),p.appendChild(M),j();let I=null,ee=r?void 0:null,te=null,ne=new gu(p,e=>L.go({kind:e}),{hasSound:!!r});addEventListener(`keydown`,e=>{if(e.target instanceof HTMLInputElement)return;let t=F.isOpen()||I?.isOpen()||ee?.isOpen()||te?.isOpen();e.key===`/`&&!t&&(e.preventDefault(),L.go({kind:`attractors`})),e.key===`t`&&!t&&L.go({kind:`today`}),e.key===`Escape`&&I?.isOpen()&&L.go({kind:`home`})});let L=new Kc(async t=>{if(p.classList.toggle(`view-open`,t.kind!==`home`),ne.setActive(t.kind===`attractors`||t.kind===`sound`||t.kind===`story`?t.kind:null),t.kind===`today`){L.go({kind:`day`,slug:bu(new Date,e).slug},{replace:!0});return}if(t.kind===`sound`){if(F.close(),I?.close(),te?.close(),ee===void 0)try{ee=new pu(p,r,()=>L.go({kind:`home`}))}catch(e){console.error(`MusicView failed to construct, disabling Sound section`,e),ee=null}ee?.open();return}if(ee?.close(),t.kind===`attractors`){F.close(),te?.close(),(I??=new su(p,e,e=>{I.close(),L.go({kind:`day`,slug:e})})).open();return}if(I?.close(),t.kind===`story`){F.close(),(te??=new mu(p,()=>L.go({kind:`home`}))).open();return}if(te?.close(),t.kind===`day`&&P.has(t.slug)){let e=P.get(t.slug),n=o.positionOf(e);await c.flyTo(n.x,n.y,8,.9),u=!0,F.open(t.slug),j()}else F.close()});c.onTap=(t,n)=>{if(F.isOpen())return;let r=Hc(c.screenToWorld(t,n),e=>o.positionOf(e),e.length,1.2);r!==null&&L.go({kind:`day`,slug:e[r].slug})},L.go(L.current(),{replace:!0}),L.current().kind===`home`&&(async()=>{if(await o.atlasReady,c.hasUserMoved()||L.current().kind!==`home`)return;let e=xu(o.positionOf(b),o.camera.fov),t=await c.flyTo(e.x,e.y,e.z,2.5,{cancellable:!0});u=!0,!(!t||c.hasUserMoved()||L.current().kind!==`home`)&&x.classList.add(`visible`)})();let re=0,ie=e=>{let t=Math.min(.05,(e-re)/1e3);re=e,c.update(t),o.render(e/1e3,F.isShowingLiveFullscreen()),F.isOpen()&&(F.render(t),o.renderer.autoClear=!1,o.renderer.render(N,o.camera),o.renderer.autoClear=!0),!F.isOpen()&&!I?.isOpen()&&!ee?.isOpen()&&!te?.isOpen()?(E.update(o.camera,i,e=>o.positionOf(e)),v.update(o.camera,i,e=>o.positionOf(e))):E.hide(),requestAnimationFrame(ie)};requestAnimationFrame(ie)}Cu();