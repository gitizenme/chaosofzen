...
void main() {
  ...
  `}function vl(e,t){if(t&&t.points.length>=3){let n=Math.floor(t.points.length/3),r=t.jitter;for(let i=0;i<e.length;i+=4){let a=Math.floor(Math.random()*n)*3;e[i]=t.points[a]+(Math.random()-.5)*r,e[i+1]=t.points[a+1]+(Math.random()-.5)*r,e[i+2]=t.points[a+2]+(Math.random()-.5)*r,e[i+3]=1}return}for(let t=0;t<e.length;t+=4)e[t]=(Math.random()-.5)*.1,e[t+1]=(Math.random()-.5)*.1,e[t+2]=(Math.random()-.5)*.1,e[t+3]=1}var yl=class{points;gpuCompute;positionVariable;material;tier;constructor(e,t,n,r,i,a){this.tier=r,this.gpuCompute=new pl(r,r,e);let o=this.gpuCompute.createTexture(),s=o.image.data;vl(s,i);let c=t.paramCount===`variable`?n.length:t.paramCount;this.positionVariable=this.gpuCompute.addVariable(`texturePosition`,_l(t,c),o),this.gpuCompute.setVariableDependencies(this.positionVariable,[this.positionVariable]),this.positionVariable.material.uniforms.uParamsA={value:n.slice()},this.positionVariable.material.uniforms.uParamsB={value:n.slice()},this.positionVariable.material.uniforms.uMorphMix={value:0},this.positionVariable.material.uniforms.uPerturbation={value:0},this.positionVariable.material.uniforms.uFrame={value:0};let l=this.gpuCompute.init();if(l!==null)throw Error(`GPUComputationRenderer init failed: ${l}`);for(let e=0;e<150;e++)this.positionVariable.material.uniforms.uFrame.value=e,this.gpuCompute.compute();let u=r*r,d=r>=2048?1.2:r>=1024?1.6:3.5,f=Math.min(1,Math.max(.12,1024*1024*1.6*1.6*.5*1.7/(u*d*d))),p=new rr;p.setAttribute(`position`,new Hn(new Float32Array(u*3),3)),this.material=new oi({vertexShader:ml,fragmentShader:hl,transparent:!0,blending:2,depthWrite:!1,uniforms:{uPosition:{value:this.gpuCompute.getCurrentRenderTarget(this.positionVariable).texture},uTexSize:{value:r},uPointSize:{value:d},uAlpha:{value:f},uBrightness:{value:1},uCalibration:{value:1},uTint:{value:a?a.clone():new Z(1,1,1)}}}),this.points=new Wr(p,this.material),this.points.frustumCulled=!1}setParams(e){this.positionVariable.material.uniforms.uParamsA.value=e.slice()}setMorphTarget(e,t){e&&(this.positionVariable.material.uniforms.uParamsB.value=e.slice()),this.positionVariable.material.uniforms.uMorphMix.value=t}setPerturbation(e){this.positionVariable.material.uniforms.uPerturbation.value=e}calibrate(e,t){let n=this.material.uniforms.uTint.value;if(n.r>.99&&n.g>.99&&n.b>.99)return;let r=t.aspect||1,i=Math.max(1,Math.round(Math.sqrt(512*512/r))),a=Math.max(1,Math.round(i*r)),o=null;try{o=new Ct(a,i);let n=new ln;n.add(this.points);let r=e.getRenderTarget(),s=new Uint8Array(a*i*4);for(let r=0;r<3;r++){e.setRenderTarget(o),e.clear(),e.render(n,t),e.readRenderTargetPixels(o,0,0,a,i,s);let r=0,c=0;for(let e=0;e<a*i;e++){let t=s[e*4],n=s[e*4+1],i=s[e*4+2];t<4&&n<4&&i<4||(r++,t>250&&n>250&&i>250&&c++)}if(r<8)break;let l=c/r;if(l<.35)break;this.material.uniforms.uCalibration.value=Math.max(.02,this.material.uniforms.uCalibration.value*(1-l))}e.setRenderTarget(r)}catch{}finally{o?.dispose()}}setBrightness(e){this.material.uniforms.uBrightness.value=Math.max(.1,e)}compute(){let e=this.positionVariable.material.uniforms.uFrame;e.value=(e.value+1)%1048576,this.gpuCompute.compute(),this.material.uniforms.uPosition.value=this.gpuCompute.getCurrentRenderTarget(this.positionVariable).texture}dispose(){this.points.geometry.dispose(),this.material.dispose(),this.gpuCompute.dispose()}},bl=.12;function xl(e){if(e.length===0)return new Z(1,1,1);let t=e.map(e=>{let t=new Z(e),n={h:0,s:0,l:0};return t.getHSL(n),n}),n=t.filter(e=>e.l>.08&&e.l<.95),r=n.length>0?n:t,i=r.reduce((e,t)=>t.s>e.s?t:e,r[0]);if(i.s<bl)return new Z(1,1,1);let a=Math.min(.7,Math.max(.45,i.l));return new Z().setHSL(i.h,Math.max(i.s,.35),a)}function Sl(e){return e.webgl2?e.isMobile?256:(e.deviceMemoryGB??0)>=8?2048:1024:null}function Cl(e){return{azimuth:0,elevation:0,radius:10,target:e}}function wl(e,t,n){let r=e.azimuth-t*.005,i=Math.max(-1.4,Math.min(1.4,e.elevation-n*.005));return{...e,azimuth:r,elevation:i}}function Tl(e,t){let n=Math.max(3,Math.min(30,e.radius*Math.exp(t*.0015)));return{...e,radius:n}}function El(e){let{azimuth:t,elevation:n,radius:r,target:i}=e;return{x:i.x+r*Math.cos(n)*Math.sin(t),y:i.y+r*Math.sin(n),z:i.z+r*Math.cos(n)*Math.cos(t)}}var Dl=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],Ol=new Set([34,5]);function kl(e,t){return(e-1+t+365)%365+1}function Al(e){let{month:t,date:n}=Ec(e.day);return`${String(e.day).padStart(3,`0`)}/365 · ${e.title} · ${Dl[t-1]} ${n}, 2010`}var jl={lorenz:`Lorenz`,lorenz_84:`Lorenz-84`,icon:`Field–Golubitsky icon`,pickover:`Pickover`,chaotic_flow:`Chaotic flow`,polynomial_a:`Polynomial A`,polynomial_b:`Polynomial B`,polynomial_c:`Polynomial C`,polynomial_func:`Polynomial`,polynomial_sprott:`Polynomial (Sprott)`,julia:`Julia (quaternion)`,ifs:`IFS`,unravel:`Unravel`};function Ml(e){return e?jl[e]??null:null}function Nl(e,t){return!e||!t||e.system===`static-only`||t.system===`static-only`||e.system!==t.system||e.params&&t.params&&(e.params.length!==t.params.length||e.system===`icon`&&e.params[0]!==t.params[0]||e.system===`julia`&&e.params[0]!==t.params[0])?`dissolve`:`morph`}function Pl(e,t){return e===`ifs`?nl(t):e===`polynomial_func`?Qc(t):t}function Fl(e,t,n,r){for(let t=0;t<n;t++)e();let i=1/0,a=-1/0,o=1/0,s=-1/0,c=1/0,l=-1/0,u=Math.max(1,Math.floor(r/4096)),d=[];for(let n=0;n<r&&(e(),!(!isFinite(t.x)||!isFinite(t.y)||!isFinite(t.z)));n++)i=Math.min(i,t.x),a=Math.max(a,t.x),o=Math.min(o,t.y),s=Math.max(s,t.y),c=Math.min(c,t.z),l=Math.max(l,t.z),n%u===0&&d.push(t.x,t.y,t.z);let f=Math.max(isFinite(a)&&isFinite(i)?(a-i)/2:0,isFinite(s)&&isFinite(o)?(s-o)/2:0,isFinite(l)&&isFinite(c)?(l-c)/2:0),p=f>.001?4/f:1,m=isFinite(i)&&isFinite(a)?(i+a)/2:0,h=isFinite(o)&&isFinite(s)?(o+s)/2:0,g=isFinite(c)&&isFinite(l)?(c+l)/2:0,_=f>.001?f*2*.01:.05;return{scale:p,centerX:m,centerY:h,centerZ:g,seed:{points:Float32Array.from(d),jitter:_}}}function Il(e){let[t,n,r,i,a]=e,o={x:.1,y:.1,z:.1};return Fl(()=>{let e=-o.y*o.y-o.z*o.z-t*o.x+t*r,s=o.x*o.y-n*o.x*o.z-o.y+i,c=n*o.x*o.y+o.x*o.z-o.z;o.x+=e*a,o.y+=s*a,o.z+=c*a},o,2e3,2e3)}function Ll(e){let t=e,n=t[21],r=(e,t,n,r)=>{let i=Math.round(e);return i<=0?1:i===1?t:i===2?n:r},i={x:.1,y:.1,z:.1};return Fl(()=>{let{x:e,y:a,z:o}=i,s=t[0]*r(t[1],e,a,o)*e+t[2]*r(t[3],e,a,o)*a+t[4]*r(t[5],e,a,o)*o+t[6],c=t[7]*r(t[8],e,a,o)*e+t[9]*r(t[10],e,a,o)*a+t[11]*r(t[12],e,a,o)*o+t[13],l=t[14]*r(t[15],e,a,o)*e+t[16]*r(t[17],e,a,o)*a+t[18]*r(t[19],e,a,o)*o+t[20];i.x+=s*n,i.y+=c*n,i.z+=l*n},i,2e3,4e3)}function Rl(e){let t=e,n={x:.1,y:.1,z:.1};return Fl(()=>{let{x:e,y:r,z:i}=n,a=t[0]+e*(t[1]+t[2]*e+t[3]*r)+r*(t[4]+t[5]*r),o=t[6]+r*(t[7]+t[8]*r+t[9]*i)+i*(t[10]+t[11]*i),s=t[12]+i*(t[13]+t[14]*i+t[15]*e)+e*(t[16]+t[17]*e);n.x=a,n.y=o,n.z=s},n,3e3,3e3)}function zl(e){let[t,n,r]=e,i={x:0,y:0,z:0};return Fl(()=>{let{x:e,y:a,z:o}=i,s=t+a-o*a,c=n+o-e*o,l=r+e-a*e;i.x=s,i.y=c,i.z=l},i,3e3,3e3)}function Bl(e){let[t,n,r,i,a,o]=e,s={x:0,y:0,z:0};return Fl(()=>{let{x:e,y:c,z:l}=s,u=t+c-l*(n+c),d=r+l-e*(i+l),f=a+e-c*(o+e);s.x=u,s.y=d,s.z=f},s,3e3,3e3)}function Vl(e){let t=Qc(e),n=t[39],r={x:.1,y:.1,z:.1};return Fl(()=>{let{x:e,y:i,z:a}=r,o=Math.abs(e),s=Math.abs(i),c=Math.abs(a),l,u,d;n<.5?(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*o+t[5]*s+t[6]*c,u=t[7]+t[8]*e+t[9]*i+t[10]*a+t[11]*o+t[12]*s+t[13]*c,d=t[14]+t[15]*e+t[16]*i+t[17]*a+t[18]*o+t[19]*s+t[20]*c):n<1.5?(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*o+t[5]*s+t[6]*c**+t[7],u=t[8]+t[9]*e+t[10]*i+t[11]*a+t[12]*o+t[13]*s+t[14]*c**+t[15],d=t[16]+t[17]*e+t[18]*i+t[19]*a+t[20]*o+t[21]*s+t[22]*c**+t[23]):(l=t[0]+t[1]*e+t[2]*i+t[3]*a+t[4]*Math.sin(t[5]*t[6]*e)+t[7]*Math.sin(t[8]*t[9]*i)+t[10]*Math.sin(t[11]*t[12]*a),u=t[13]+t[14]*e+t[15]*i+t[16]*a+t[17]*Math.sin(t[18]*t[19]*e)+t[20]*Math.sin(t[21]*t[22]*i)+t[23]*Math.sin(t[24]*t[25]*a),d=t[26]+t[27]*e+t[28]*i+t[29]*a+t[30]*Math.sin(t[31]*t[32]*e)+t[33]*Math.sin(t[34]*t[35]*i)+t[36]*Math.sin(t[37]*t[38]*a)),r.x=l,r.y=u,r.z=d},r,3e3,3e3)}function Hl(e){let t=nl(e),n={x:.1,y:.1,z:.1};return Fl(()=>rl(t,n,Math.random),n,200,4e3)}function Ul(e){let t={x:.1,y:.1,z:.1};return Fl(()=>rl(e,t,Math.random),t,200,4e3)}function Wl(e){let t=Math.round(e[0]),[,n,r,i,a,o]=e,s={x:.1,y:.1,z:0};return Fl(()=>{let e=1,c=0;for(let n=0;n<t-1;n++){let t=e*s.x-c*s.y;c=e*s.y+c*s.x,e=t}let l=i+n*(s.x*s.x+s.y*s.y)+r*(s.x*e-s.y*c),u=l*s.x+a*e-o*s.y,d=l*s.y-a*c+o*s.x;s.x=u,s.y=d,s.z=Math.abs(l)},s,500,4e3)}function Gl(e){let[t,n,r,i,a,o,s]=e,c={x:.1,y:.1,z:.1};return Fl(()=>{let e=i*(c.z+t),l=a*(c.x+n),u=o*(c.y+r),d=Math.hypot(e,l,u);if(d>s&&s>0){let t=1-s*(Math.floor(d/s)+1)/d;e*=t,l*=t,u*=t}c.x=e,c.y=l,c.z=u},c,500,4e3)}function Kl(e){let t={x:.5,y:.3,z:.2,w:.1},n={x:t.x,y:t.y,z:t.z};return Fl(()=>{sl(e,t,Math.random),n.x=t.x,n.y=t.y,n.z=t.z},n,200,4e3)}var ql=.2,Jl=3.2,Yl={lorenz:e=>({scale:ql,centerX:0,centerY:0,centerZ:e.length>=2?e[1]-1:0}),pickover:()=>({scale:Jl,centerX:0,centerY:0,centerZ:0}),lorenz_84:e=>({...Il(e),seed:void 0}),chaotic_flow:Ll,polynomial_c:Rl,polynomial_func:Vl,polynomial_a:zl,polynomial_b:Bl,ifs:Hl,incendia_ifs:Ul,icon:Wl,unravel:Gl,julia:Kl},Xl=`la-brightness`;function Zl(){let e=Number(localStorage.getItem(Xl));return Number.isFinite(e)&&e>0?e:1}var Ql=class{overlay;onNavigate;onClose;root;img;sources;caption;prevBtn;nextBtn;listenBtn;audioEl=new Audio;current=null;bySlug;byDay;live_;attractorsByDay=new Map;tier=null;liveAttractor=null;orbit=null;orbitDragging=!1;orbitLast={x:0,y:0};orbitMoved=0;disturbHeld=!1;disturbAmount=0;brightness=Zl();constructor(e,t,n,r,i){this.overlay=e,this.onNavigate=n,this.onClose=r,this.bySlug=new Map(t.map(e=>[e.slug,e])),this.byDay=new Map(t.map(e=>[e.day,e])),this.root=document.createElement(`div`),this.root.className=`piece hidden`,this.root.innerHTML=`
      ...
      </div>`,e.appendChild(this.root),this.root.querySelector(`.story-close`).addEventListener(`click`,()=>this.requestClose()),this.root.addEventListener(`click`,e=>{e.target===this.root&&this.requestClose()}),addEventListener(`keydown`,e=>{this.isOpen()&&e.key===`Escape`&&this.requestClose()})}requestClose(){this.close(),this.onClose()}open(){this.openState=!0,this.root.classList.remove(`hidden`)}close(){this.openState=!1,this.root.classList.add(`hidden`)}isOpen(){return this.openState}},lu=[{kind:`today`,label:`Today`,title:`Today — this date's attractor (or press t)`},{kind:`attractors`,label:`Attractors`,title:`Attractors — browse all 365 days (or press /)`},{kind:`sound`,label:`Sound`,title:`Sound — music from the attractors`},{kind:`story`,label:`Story`,title:`Story — one attractor a day, 2010`}],uu=class{root;links=new Map;constructor(e,t,n){this.root=document.createElement(`nav`),this.root.id=`nav-row`;for(let e of lu){if(e.kind===`sound`&&!n.hasSound)continue;let r=document.createElement(`a`);r.href=`/${e.kind}/`,r.textContent=e.label,r.title=e.title,r.addEventListener(`click`,n=>{n.preventDefault(),t(e.kind)}),this.root.appendChild(r),this.links.set(e.kind,r)}e.appendChild(this.root)}setActive(e){for(let[t,n]of this.links)n.classList.toggle(`active`,t===e)}},du=[31,28,31,30,31,30,31,31,30,31,30,31],fu=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`];function pu(e,t){let n=e===2&&t===29?28:t,r=0;for(let t=0;t<e-1;t++)r+=du[t];return r+n}function mu(e,t){let n=pu(e.getMonth()+1,e.getDate());return t.find(e=>e.day===n)}function hu(e,t,n=1.6,r=.15){let i=n/r;return{x:e.x,y:e.y,z:i/(2*Math.tan(t*Math.PI/360))}}function gu(e){let{month:t,date:n}=Ec(e.day);return{label:`Day ${String(e.day).padStart(3,`0`)} · ${fu[t-1]} ${n}`,title:e.title}}async function _u(){let[{artworks:e,atlas:t},n,r]=await Promise.all([Sc(),Cc(),au().catch(()=>null)]),i=document.getElementById(`gl`),a=kc(e),o;try{o=new Mc(i,e,t)}catch(e){console.error(`WebGL unavailable, falling back to static page`,e);return}document.querySelector(`.static-piece`)?.remove(),document.querySelector(`.static-nav`)?.remove();let s=matchMedia(`(prefers-reduced-motion: reduce)`);o.setReducedMotion(s.matches);let c=new zc(i,o.camera,a,{reducedMotion:s.matches}),l=!1,u=!1,d=()=>{let t=i.clientWidth,n=i.clientHeight;if(!t||!n){requestAnimationFrame(f);return}o.resize();let r=Fc(kc(e,l?`date`:`likeness`),t/n,o.camera.fov,.85);o.camera.position.set(r.x,r.y,r.z)},f=()=>{c.hasUserMoved()||u||d()};d(),addEventListener(`resize`,()=>{o.resize(),c.hasUserMoved()||d()}),s.addEventListener(`change`,()=>o.setReducedMotion(s.matches));let p=document.getElementById(`overlay`),m=document.createElement(`div`);m.id=`layout-switch`;let h=document.createElement(`button`);h.textContent=`Likeness`,h.title=`Arrange the constellation by visual similarity`;let g=document.createElement(`button`);g.textContent=`Date`,g.title=`Arrange the constellation by calendar date`,m.append(h,g),p.appendChild(m);let _=e=>{h.classList.toggle(`active`,!e),g.classList.toggle(`active`,e),h.setAttribute(`aria-pressed`,String(!e)),g.setAttribute(`aria-pressed`,String(e)),l=e,o.setTimeMix(+!!e),c.hasUserMoved()||d()};h.addEventListener(`click`,()=>_(!1)),g.addEventListener(`click`,()=>_(!0)),_(!1);let v=new iu(p,e,(e,t)=>c.flyTo(e,t,o.camera.position.z,.6)),y=mu(new Date,e),b=e.findIndex(e=>e.day===y.day);o.setHighlight(b);let x=document.createElement(`div`);x.id=`today-caption`;let S=gu(y),C=document.createElement(`small`);C.textContent=S.label;let w=document.createElement(`span`);if(w.textContent=S.title,x.append(C,w),!localStorage.getItem(`la-intro-seen`)){let e=document.createElement(`p`);e.className=`today-hints`,e.textContent=`drag to wander · scroll to dive · click to open`,x.appendChild(e)}p.appendChild(x);let T=()=>{x.classList.remove(`visible`),localStorage.setItem(`la-intro-seen`,`1`)};i.addEventListener(`pointerdown`,T,{once:!0}),i.addEventListener(`wheel`,T,{once:!0});let E=new Vc(p,e),D=null;i.addEventListener(`pointermove`,t=>{D=Bc(c.screenToWorld(t.clientX,t.clientY),e=>o.positionOf(e),e.length,1.2),o.setHover(D),i.style.cursor=D===null?`grab`:`pointer`});let O=document.createElement(`div`);O.id=`mode-toggle`;let k=document.createElement(`button`);k.textContent=`Image`,k.title=`Show the 2010 static render`;let A=document.createElement(`button`);A.textContent=`Orbit`,A.title=`Show only the live attractor`,O.append(k,A);let ee=()=>{let e=P.isHidingStatic();k.classList.toggle(`active`,!e),A.classList.toggle(`active`,e),k.setAttribute(`aria-pressed`,String(!e)),A.setAttribute(`aria-pressed`,String(e))};k.addEventListener(`click`,()=>{P.isHidingStatic()&&(P.toggleHideStatic(),ee())}),A.addEventListener(`click`,()=>{P.isHidingStatic()||(P.toggleHideStatic(),ee())});let j=document.createElement(`input`);j.id=`brightness-slider`,j.type=`range`,j.min=`0.4`,j.max=`6`,j.step=`0.1`,j.setAttribute(`aria-label`,`Live attractor brightness`);let M=new ln,N=new Map(e.map((e,t)=>[e.slug,t])),P=new Ql(p,e,e=>L.go({kind:`day`,slug:e}),()=>L.go({kind:`home`}),{attractors:n,renderer:o.renderer,liveScene:M,camera:o.camera,canvas:i,controls:c,modeToggle:O,brightnessSlider:j});p.appendChild(O),p.appendChild(j),ee();let F=null,te=r?void 0:null,I=null,ne=new uu(p,e=>L.go({kind:e}),{hasSound:!!r});addEventListener(`keydown`,e=>{if(e.target instanceof HTMLInputElement)return;let t=P.isOpen()||F?.isOpen()||te?.isOpen()||I?.isOpen();e.key===`/`&&!t&&(e.preventDefault(),L.go({kind:`attractors`})),e.key===`t`&&!t&&L.go({kind:`today`}),e.key===`Escape`&&F?.isOpen()&&L.go({kind:`home`})});let L=new Wc(async t=>{if(p.classList.toggle(`view-open`,t.kind!==`home`),ne.setActive(t.kind===`attractors`||t.kind===`sound`||t.kind===`story`?t.kind:null),t.kind===`today`){L.go({kind:`day`,slug:mu(new Date,e).slug},{replace:!0});return}if(t.kind===`sound`){if(P.close(),F?.close(),I?.close(),te===void 0)try{te=new su(p,r,()=>L.go({kind:`home`}))}catch(e){console.error(`MusicView failed to construct, disabling Sound section`,e),te=null}te?.open();return}if(te?.close(),t.kind===`attractors`){P.close(),I?.close(),(F??=new tu(p,e,e=>{F.close(),L.go({kind:`day`,slug:e})})).open();return}if(F?.close(),t.kind===`story`){P.close(),(I??=new cu(p,()=>L.go({kind:`home`}))).open();return}if(I?.close(),t.kind===`day`&&N.has(t.slug)){let e=N.get(t.slug),n=o.positionOf(e);await c.flyTo(n.x,n.y,8,.9),u=!0,P.open(t.slug),ee()}else P.close()});c.onTap=(t,n)=>{if(P.isOpen())return;let r=Bc(c.screenToWorld(t,n),e=>o.positionOf(e),e.length,1.2);r!==null&&L.go({kind:`day`,slug:e[r].slug})},L.go(L.current(),{replace:!0}),L.current().kind===`home`&&(async()=>{if(await o.atlasReady,c.hasUserMoved()||L.current().kind!==`home`)return;let e=hu(o.positionOf(b),o.camera.fov),t=await c.flyTo(e.x,e.y,e.z,2.5,{cancellable:!0});u=!0,!(!t||c.hasUserMoved()||L.current().kind!==`home`)&&x.classList.add(`visible`)})();let re=0,ie=e=>{let t=Math.min(.05,(e-re)/1e3);re=e,c.update(t),o.render(e/1e3,P.isShowingLiveFullscreen()),P.isOpen()&&(P.render(t),o.renderer.autoClear=!1,o.renderer.render(M,o.camera),o.renderer.autoClear=!0),!P.isOpen()&&!F?.isOpen()&&!te?.isOpen()&&!I?.isOpen()?(E.update(o.camera,i,e=>o.positionOf(e)),v.update(o.camera,i,e=>o.positionOf(e))):E.hide(),requestAnimationFrame(ie)};requestAnimationFrame(ie)}_u();